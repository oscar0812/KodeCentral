...
class CommentTableMap extends TableMap
{
    ...
    /**
     * the column name for the posted_time field
     */
    const COL_POSTED_TIME = 'comment.posted_time';
     ...
     */
    const COL_POST_ID = 'comment.post_id';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Text', 'PostedTime', 'UserId', 'PostId', ),
        self::TYPE_CAMELNAME     => array('id', 'text', 'postedTime', 'userId', 'postId', ),
        self::TYPE_COLNAME       => array(CommentTableMap::COL_ID, CommentTableMap::COL_TEXT, CommentTableMap::COL_POSTED_TIME, CommentTableMap::COL_USER_ID, CommentTableMap::COL_POST_ID, ),
        self::TYPE_FIELDNAME     => array('id', 'text', 'posted_time', 'user_id', 'post_id', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Text' => 1, 'PostedTime' => 2, 'UserId' => 3, 'PostId' => 4, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'text' => 1, 'postedTime' => 2, 'userId' => 3, 'postId' => 4, ),
        self::TYPE_COLNAME       => array(CommentTableMap::COL_ID => 0, CommentTableMap::COL_TEXT => 1, CommentTableMap::COL_POSTED_TIME => 2, CommentTableMap::COL_USER_ID => 3, CommentTableMap::COL_POST_ID => 4, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'text' => 1, 'posted_time' => 2, 'user_id' => 3, 'post_id' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('text', 'Text', 'VARCHAR', true, 512, null);
        $this->addColumn('posted_time', 'PostedTime', 'TIMESTAMP', true, null, null);
  ...
  array (
    ...
    {
        return array(
            'validate' => array('rule1' => array ('column' => 'text','validator' => 'NotNull',), 'rule2' => array ('column' => 'posted_time','validator' => 'NotNull',), ),
        );
    } // getBehaviors()
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(CommentTableMap::COL_POSTED_TIME);
            $criteria->addSelectColumn(CommentTableMap::COL_USER_ID);
            $criteria->addSelectColumn(CommentTableMap::COL_POST_ID);
        } else {
            $criteria->addSelectColumn($alias . '.id');
            $criteria->addSelectColumn($alias . '.text');
            $criteria->addSelectColumn($alias . '.posted_time');
