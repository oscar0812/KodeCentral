...
class PostTableMap extends TableMap
{
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Title', 'Summary', 'Text', ),
        self::TYPE_CAMELNAME     => array('id', 'title', 'summary', 'text', ),
        self::TYPE_COLNAME       => array(PostTableMap::COL_ID, PostTableMap::COL_TITLE, PostTableMap::COL_SUMMARY, PostTableMap::COL_TEXT, ),
        self::TYPE_FIELDNAME     => array('id', 'title', 'summary', 'text', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Title' => 1, 'Summary' => 2, 'Text' => 3, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'title' => 1, 'summary' => 2, 'text' => 3, ),
        self::TYPE_COLNAME       => array(PostTableMap::COL_ID => 0, PostTableMap::COL_TITLE => 1, PostTableMap::COL_SUMMARY => 2, PostTableMap::COL_TEXT => 3, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'title' => 1, 'summary' => 2, 'text' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('summary', 'Summary', 'INTEGER', true, null, null);
