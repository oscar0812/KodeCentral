...
<html lang="en">
  ...
  <body>
                  ...
                  <ul class="panel-group ms-collapse-nav" id="components-nav" role="tablist" aria-multiselectable="true">
                    ...
                    <li class="card" role="tab" id="e7">
                      ...
                      <ul id="c7" class="panel-collapse collapse show" role="tabpanel" aria-labelledby="e7" data-parent="#components-nav">
                        <li>
                          <a class="withripple active" href="component-charts-circle.php">
            ...
            <div class="col-lg-9 ms-paper-content-container">
              <div class="ms-paper-content">
                ...
                <div class="alert alert-info alert-light alert-dismissible" role="alert">
                  ...
                  </button> Material Style contains the library
                  <a href="https://github.com/lugolabs/circles">circles.js</a> to create statistical circles. You can use all you need, here are some examples. </div>
                <section class="ms-component-section">
                  <h2 class="section-title">Basic Circles</h2>
                  <div class="row mt-4">
                    <div class="col-lg-3 col-sm-6">
                      <div class="text-center">
                        <div class="circle" id="circles-1"></div>
                        <h3 class="color-primary">HTML 5</h3>
                    ...
                    <div class="col-lg-3 col-sm-6">
                      <div class="text-center">
                        ...
                        <h3 class="color-primary">CSS 3</h3>
                        <p class="small">Lorem ipsum dolor sit amet consectetur adipisicing.</p>
                      </div>
                    </div>
                    <div class="col-lg-3 col-sm-6">
                      <div class="text-center">
                        ...
                        <h3 class="color-primary">Gulp</h3>
                        <p class="small">Lorem ipsum dolor sit amet consectetur adipisicing.</p>
                      </div>
                    </div>
                    <div class="col-lg-3 col-sm-6">
                      <div class="text-center">
                        ...
                        <h3 class="color-primary">Bootstrap</h3>
                        <p class="small">Lorem ipsum dolor sit amet consectetur adipisicing.</p>
                      </div>
                    </div>
                  </div>
                  <hr class="dotted">
                  <h2 class="mb-4 text-center">Different Sizes</h2>
                  <div class="row">
                    <div class="col-lg-3 col-sm-6">
                      <div class="text-center">
                  ...
                  <hr class="dotted">
                  <h2 class="mb-4 text-center">Different Colors</h2>
                  <div class="row">
                    <div class="col-lg-3 col-sm-6">
                      <div class="text-center">
                  ...
                  <div class="card card-info card-code">
                    ...
                    <div id="code1" class="card-collapse collapse" role="tabpanel" aria-labelledby="codeHead1">
                      <div class="card-code-block"> <pre><code class="language-javascript line-numbers">$( document ).ready(function() {
    ...
    <script src="assets/js/charts-circle.js"></script>
  </body>
</html>