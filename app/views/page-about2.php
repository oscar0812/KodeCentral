        ...
        <div class="container">
          <div class="text-center">
            ...
            <div class="row mb-4 mt-4">
              <div class="col-md-3 col-sm-6 animated zoomInUp animation-delay-5">
                <i class="zmdi zmdi-accounts color-primary zmdi-hc-4x"></i>
                <h4 class="color-white text-uppercase">Lorem ipsum dolor</h4>
              </div>
              <div class="col-md-3 col-sm-6 animated zoomInUp animation-delay-6">
                <i class="zmdi zmdi-brightness-7 color-primary zmdi-hc-4x"></i>
                <h4 class="color-white text-uppercase">Lorem ipsum dolor</h4>
              </div>
              <div class="col-md-3 col-sm-6 animated zoomInUp animation-delay-7">
                <i class="zmdi zmdi-time color-primary zmdi-hc-4x"></i>
                <h4 class="color-white text-uppercase">Lorem ipsum dolor</h4>
              </div>
              <div class="col-md-3 col-sm-6 animated zoomInUp animation-delay-8">
      ...
      <div class="container wow fadeInUp">
        <div class="row">
          <div class="col-lg-6 text-justify">
            ...
            <p class="dropcaps">Non sequi adipisci nostrum natus rem accusamus itaque repellendus illum neque! Voluptate, error commodi a quaerat eveniet tenetur reiciendis nulla doloremque iusto repellat quis asperiores, quibusdam architecto culpa facere aliquam placeat
              eaque amet, nesciunt vero sunt veniam est quasi doloribus optio nobis alias maiores. Nulla perferendis impedit hic doloremque iusto placeat veniam distinctio error.</p>
            <p>Tenetur numquam a, nesciunt neque odit amet, qui quibusdam natus assumenda quas omnis, aspernatur quisquam nobis illum ea distinctio tempora quaerat. Aperiam cumque, eveniet similique praesentium, temporibus, id quis labore aspernatur quod
              placeat ducimus fuga consequuntur numquam autem. Voluptates repellat.</p>
            <p class="text-right">
