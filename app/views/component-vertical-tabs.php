                  ...
                  <ul class="panel-group ms-collapse-nav" id="components-nav" role="tablist" aria-multiselectable="true">
                    ...
                    <li class="card" role="tab" id="e6">
                      ...
                      <ul id="c6" class="panel-collapse collapse show" role="tabpanel" aria-labelledby="e6" data-parent="#components-nav">
                        ...
                        <li>
                          <a class="withripple active" href="component-vertical-tabs.php">
                            <i class="zmdi zmdi-menu"></i> Vertical Tabs</a>
                        </li>
                      </ul>
                    </li>
            ...
            <div class="col-lg-9 ms-paper-content-container">
              <div class="ms-paper-content">
                ...
                <section class="ms-component-section">
                  <h2 class="section-title">Bacic Tabs</h2>
                    ...
                    <div class="row">
                      <div class="col-lg-3">
                        <ul class="nav nav-tabs-ver" role="tablist">
                          ...
                          <li class="nav-item">
                            <a class="nav-link" href="#messages" aria-controls="messages" role="tab" data-toggle="tab">
                        ...
                        <div class="card-body">
                          <div class="tab-content">
                            <div role="tabpanel" class="tab-pane active" id="home">
                              <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quam soluta, provident similique necessitatibus nihil officiis nam eius dolore ab ad eveniet aliquam est, repellendus reiciendis, perspiciatis aliquid. Voluptatum
                                quasi corporis quisquam autem distinctio, numquam sint. Debitis cumque fugit nulla soluta laudantium sapiente atque a beatae excepturi. Sapiente error temporibus necessitatibus.</p>
                              <p>Facere excepturi qui reiciendis corporis, beatae modi ab distinctio amet adipisci, voluptate error optio. Cupiditate quidem exercitationem sed laudantium. Quasi minima unde soluta optio saepe ipsam! Earum at animi dignissimos
                                accusantium suscipit, placeat voluptates facilis deserunt soluta quam accusamus, iure consectetur quos deleniti porro doloremque aspernatur mollitia.</p>
                            </div>
                            <div role="tabpanel" class="tab-pane" id="profile">
                              <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Modi impedit dicta nam temporibus sunt debitis laudantium sequi accusamus corporis vel nostrum dolorum eos dolor earum explicabo totam sint assumenda, esse magnam,
                                illo velit. Aliquam quisquam perferendis deserunt fugit id ut beatae pariatur nisi rerum. Recusandae natus laboriosam ex eos iure.</p>
                              <p>Animi neque ad eius voluptates dolor, excepturi, ipsam libero consequuntur vero iusto in. Consequuntur cupiditate repudiandae nisi illo accusamus doloremque ipsum dicta, voluptates obcaecati velit corrupti assumenda, est
                                libero ratione consequatur modi aliquid non aperiam! Magni, beatae, adipisci architecto aut doloremque iste optio debitis cupiditate illo animi consequatur qui sint.</p>
                            </div>
                            <div role="tabpanel" class="tab-pane" id="messages">
                              <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quod quia ex nam? Eaque modi quam iure eius, enim laboriosam et vitae atque consequuntur commodi adipisci nostrum ratione, in nemo possimus saepe. Facere maiores a
                                deleniti temporibus, alias neque tempore nulla, nihil cumque eligendi itaque eum dolorum dolore veniam delectus necessitatibus.</p>
                              <p>Voluptate maxime, pariatur aspernatur nulla. Ducimus amet, ipsam eum mollitia repellat praesentium fugiat nisi ut incidunt rerum. Blanditiis, commodi sequi eos, asperiores ipsa eaque officiis hic at iusto. Velit dolor eligendi,
                                obcaecati, nisi et fugit neque ipsam saepe, magnam veritatis molestiae, praesentium voluptatum dolorem modi debitis quo! Provident in, ipsam.</p>
                            </div>
                            <div role="tabpanel" class="tab-pane" id="settings">
                              <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Laborum provident, assumenda maxime labore, quod ratione ipsa vel reiciendis minus sit veritatis atque non facere. Ullam atque reprehenderit debitis nostrum, nihil
                                laboriosam cupiditate totam doloremque velit distinctio nulla quisquam assumenda quod cum sequi consectetur voluptates necessitatibus ab placeat, voluptas alias sit.</p>
                              <p>Debitis iste asperiores nam voluptates repellat eveniet. Laboriosam, nam reprehenderit natus quam alias quo pariatur esse dolore voluptates enim fugiat minima corrupti animi nihil quia ratione quaerat magni, vero vitae hic
                                numquam totam eligendi, incidunt doloremque! Obcaecati voluptatum, asperiores ut, laudantium velit earum eligendi laboriosam autem est ipsa quos! Dolor!</p>
                            </div>
                          </div>
                        </div>
                      </div>
                  ...
                  <h3>With data-hover</h3>
                  <div class="card nav-tabs-ver-container">
                    <div class="row">
                      <div class="col-lg-3">
                        <ul class="nav nav-tabs-ver" role="tablist">
                          <li class="nav-item">
                            <a class="nav-link active" href="#home2" aria-controls="home2" role="tab" data-hover="tab" data-toggle="tab">
                              <i class="zmdi zmdi-home"></i> Home</a>
                          </li>
                          <li class="nav-item">
                            <a class="nav-link" href="#profile2" aria-controls="profile2" role="tab" data-hover="tab" data-toggle="tab">
                              <i class="zmdi zmdi-account"></i> Profile</a>
                          </li>
                          <li class="nav-item">
                            <a class="nav-link" href="#messages2" aria-controls="messages2" role="tab" data-hover="tab" data-toggle="tab">
                              <i class="zmdi zmdi-email"></i> Messages</a>
                          </li>
                          <li class="nav-item">
                            <a class="nav-link" href="#settings2" aria-controls="settings2" role="tab" data-hover="tab" data-toggle="tab">
                              <i class="zmdi zmdi-settings"></i> Settings</a>
                          </li>
                        </ul>
                      </div>
                  ...
                  <div class="card card-info card-code">
                    ...
                    <div id="code1" class="card-collapse collapse" role="tabpanel" aria-labelledby="codeHead1">
                      <div class="card-code-block"> <pre><code class="language-markup line-numbers">&lt;h2 class=&quot;section-title&quot;&gt;Bacic Tabs&lt;/h2&gt;

&lt;div class=&quot;card nav-tabs-ver-container&quot;&gt;
    &lt;div class=&quot;row&quot;&gt;
        &lt;div class=&quot;col-lg-3&quot;&gt;
            &lt;ul class=&quot;nav nav-tabs-ver&quot; role=&quot;tablist&quot;&gt;
                &lt;li class=&quot;nav-item&quot;&gt;&lt;a class=&quot;nav-link active&quot; href=&quot;#home&quot; aria-controls=&quot;home&quot; role=&quot;tab&quot; data-toggle=&quot;tab&quot;&gt;&lt;i class=&quot;zmdi zmdi-home&quot;&gt;&lt;/i&gt; Home&lt;/a&gt;&lt;/li&gt;
                &lt;li class=&quot;nav-item&quot;&gt;&lt;a class=&quot;nav-link&quot; href=&quot;#profile&quot; aria-controls=&quot;profile&quot; role=&quot;tab&quot; data-toggle=&quot;tab&quot;&gt;&lt;i class=&quot;zmdi zmdi-account&quot;&gt;&lt;/i&gt; Profile&lt;/a&gt;&lt;/li&gt;
                &lt;li class=&quot;nav-item&quot;&gt;&lt;a class=&quot;nav-link&quot; href=&quot;#messages&quot; aria-controls=&quot;messages&quot; role=&quot;tab&quot; data-toggle=&quot;tab&quot;&gt;&lt;i class=&quot;zmdi zmdi-email&quot;&gt;&lt;/i&gt; Messages&lt;/a&gt;&lt;/li&gt;
                &lt;li class=&quot;nav-item&quot;&gt;&lt;a class=&quot;nav-link&quot; href=&quot;#settings&quot; aria-controls=&quot;settings&quot; role=&quot;tab&quot; data-toggle=&quot;tab&quot;&gt;&lt;i class=&quot;zmdi zmdi-settings&quot;&gt;&lt;/i&gt; Settings&lt;/a&gt;&lt;/li&gt;
            &lt;/ul&gt;
        &lt;/div&gt;
        &lt;div class=&quot;col-lg-9 nav-tabs-ver-container-content&quot;&gt;
            &lt;div class=&quot;card-body&quot;&gt;
...
&lt;div class=&quot;card nav-tabs-ver-container&quot;&gt;
    &lt;div class=&quot;row&quot;&gt;
        &lt;div class=&quot;col-lg-3&quot;&gt;
            &lt;ul class=&quot;nav nav-tabs-ver&quot; role=&quot;tablist&quot;&gt;
                &lt;li class=&quot;nav-item&quot;&gt;&lt;a class=&quot;nav-link active&quot; href=&quot;#home2&quot; aria-controls=&quot;home2&quot; role=&quot;tab&quot; data-hover=&quot;tab&quot; data-toggle=&quot;tab&quot;&gt;&lt;i class=&quot;zmdi zmdi-home&quot;&gt;&lt;/i&gt; Home&lt;/a&gt;&lt;/li&gt;
                &lt;li class=&quot;nav-item&quot;&gt;&lt;a class=&quot;nav-link&quot; href=&quot;#profile2&quot; aria-controls=&quot;profile2&quot; role=&quot;tab&quot; data-hover=&quot;tab&quot; data-toggle=&quot;tab&quot;&gt;&lt;i class=&quot;zmdi zmdi-account&quot;&gt;&lt;/i&gt; Profile&lt;/a&gt;&lt;/li&gt;
                &lt;li class=&quot;nav-item&quot;&gt;&lt;a class=&quot;nav-link&quot; href=&quot;#messages2&quot; aria-controls=&quot;messages2&quot; role=&quot;tab&quot; data-hover=&quot;tab&quot; data-toggle=&quot;tab&quot;&gt;&lt;i class=&quot;zmdi zmdi-email&quot;&gt;&lt;/i&gt; Messages&lt;/a&gt;&lt;/li&gt;
                &lt;li class=&quot;nav-item&quot;&gt;&lt;a class=&quot;nav-link&quot; href=&quot;#settings2&quot; aria-controls=&quot;settings2&quot; role=&quot;tab&quot; data-hover=&quot;tab&quot; data-toggle=&quot;tab&quot;&gt;&lt;i class=&quot;zmdi zmdi-settings&quot;&gt;&lt;/i&gt; Settings&lt;/a&gt;&lt;/li&gt;
            &lt;/ul&gt;
        &lt;/div&gt;
        &lt;div class=&quot;col-lg-9 nav-tabs-ver-container-content&quot;&gt;
            &lt;div class=&quot;card-body&quot;&gt;
...
&lt;/div&gt;</code></pre> </div>
                ...
                <section class="ms-component-section">
                  <h2 class="section-title">With Colors</h2>
                  <div class="card nav-tabs-ver-container">
                    <div class="row">
                      <div class="col-lg-3">
                        <ul class="nav nav-tabs-ver nav-tabs-ver-primary" role="tablist">
                          <li class="nav-item">
                            <a class="nav-link active" href="#home3" aria-controls="home3" role="tab" data-toggle="tab">
                              <i class="zmdi zmdi-home"></i> Home</a>
                          </li>
                          <li class="nav-item">
                            <a class="nav-link" href="#profile3" aria-controls="profile3" role="tab" data-toggle="tab">
                              <i class="zmdi zmdi-account"></i> Profile</a>
                          </li>
                          <li class="nav-item">
                            <a class="nav-link" href="#messages3" aria-controls="messages3" role="tab" data-toggle="tab">
                              <i class="zmdi zmdi-email"></i> Messages</a>
                          </li>
                          <li class="nav-item">
                            <a class="nav-link" href="#settings3" aria-controls="settings3" role="tab" data-toggle="tab">
                              <i class="zmdi zmdi-settings"></i> Settings</a>
                          </li>
                        </ul>
                      </div>
                  ...
                  <div class="card nav-tabs-ver-container">
                    <div class="row">
                      <div class="col-lg-3">
                        <ul class="nav nav-tabs-ver nav-tabs-ver-danger" role="tablist">
                          <li class="nav-item">
                            <a class="nav-link active" href="#home4" aria-controls="home4" role="tab" data-toggle="tab">
                              <i class="zmdi zmdi-home"></i> Home</a>
                          </li>
                          <li class="nav-item">
                            <a class="nav-link" href="#profile4" aria-controls="profile4" role="tab" data-toggle="tab">
                              <i class="zmdi zmdi-account"></i> Profile</a>
                          </li>
                          <li class="nav-item">
                            <a class="nav-link" href="#messages4" aria-controls="messages4" role="tab" data-toggle="tab">
                              <i class="zmdi zmdi-email"></i> Messages</a>
                          </li>
                          <li class="nav-item">
                            <a class="nav-link" href="#settings4" aria-controls="settings4" role="tab" data-toggle="tab">
                              <i class="zmdi zmdi-settings"></i> Settings</a>
                          </li>
                        </ul>
                      </div>
                  ...
                  <div class="card nav-tabs-ver-container">
                    <div class="row">
                      <div class="col-lg-3">
                        <ul class="nav nav-tabs-ver nav-tabs-ver-warning" role="tablist">
                          <li class="nav-item">
                            <a class="nav-link active" href="#home5" aria-controls="home5" role="tab" data-toggle="tab">
                              <i class="zmdi zmdi-home"></i> Home</a>
                          </li>
                          <li class="nav-item">
                            <a class="nav-link" href="#profile5" aria-controls="profile5" role="tab" data-toggle="tab">
                              <i class="zmdi zmdi-account"></i> Profile</a>
                          </li>
                          <li class="nav-item">
                            <a class="nav-link" href="#messages5" aria-controls="messages5" role="tab" data-toggle="tab">
                              <i class="zmdi zmdi-email"></i> Messages</a>
                          </li>
                          <li class="nav-item">
                            <a class="nav-link" href="#settings5" aria-controls="settings5" role="tab" data-toggle="tab">
                              <i class="zmdi zmdi-settings"></i> Settings</a>
                          </li>
                        </ul>
                      </div>
                  ...
                  <div class="card nav-tabs-ver-container">
                    <div class="row">
                      <div class="col-lg-3">
                        <ul class="nav nav-tabs-ver nav-tabs-ver-success" role="tablist">
                          <li class="nav-item">
                            <a class="nav-link active" href="#home6" aria-controls="home6" role="tab" data-toggle="tab">
                              <i class="zmdi zmdi-home"></i> Home</a>
                          </li>
                          <li class="nav-item">
                            <a class="nav-link" href="#profile6" aria-controls="profile6" role="tab" data-toggle="tab">
                              <i class="zmdi zmdi-account"></i> Profile</a>
                          </li>
                          <li class="nav-item">
                            <a class="nav-link" href="#messages6" aria-controls="messages6" role="tab" data-toggle="tab">
                              <i class="zmdi zmdi-email"></i> Messages</a>
                          </li>
                          <li class="nav-item">
                            <a class="nav-link" href="#settings6" aria-controls="settings6" role="tab" data-toggle="tab">
                              <i class="zmdi zmdi-settings"></i> Settings</a>
                          </li>
                        </ul>
                      </div>
                    ...
                    <div class="row">
                      <div class="col-lg-3">
                        <ul class="nav nav-tabs-ver nav-tabs-ver-info" role="tablist">
                          <li class="nav-item">
                            <a class="nav-link active" href="#home7" aria-controls="home7" role="tab" data-toggle="tab">
                              <i class="zmdi zmdi-home"></i> Home</a>
                          </li>
                          <li class="nav-item">
                            <a class="nav-link" href="#profile7" aria-controls="profile7" role="tab" data-toggle="tab">
                              <i class="zmdi zmdi-account"></i> Profile</a>
                          </li>
                          <li class="nav-item">
                            <a class="nav-link" href="#messages7" aria-controls="messages7" role="tab" data-toggle="tab">
                              <i class="zmdi zmdi-email"></i> Messages</a>
                          </li>
                          <li class="nav-item">
                            <a class="nav-link" href="#settings7" aria-controls="settings7" role="tab" data-toggle="tab">
                              <i class="zmdi zmdi-settings"></i> Settings</a>
                          </li>
                        </ul>
                      </div>
                  ...
                  <div class="card nav-tabs-ver-container">
                    <div class="row">
                      <div class="col-lg-3">
                        <ul class="nav nav-tabs-ver nav-tabs-ver-royal" role="tablist">
                          <li class="nav-item">
                            <a class="nav-link active" href="#home8" aria-controls="home8" role="tab" data-toggle="tab">
                              <i class="zmdi zmdi-home"></i> Home</a>
                          </li>
                          <li class="nav-item">
                            <a class="nav-link" href="#profile8" aria-controls="profile8" role="tab" data-toggle="tab">
                              <i class="zmdi zmdi-account"></i> Profile</a>
                          </li>
                          <li class="nav-item">
                            <a class="nav-link" href="#messages8" aria-controls="messages8" role="tab" data-toggle="tab">
                              <i class="zmdi zmdi-email"></i> Messages</a>
                          </li>
                          <li class="nav-item">
                            <a class="nav-link" href="#settings8" aria-controls="settings8" role="tab" data-toggle="tab">
                              <i class="zmdi zmdi-settings"></i> Settings</a>
                          </li>
                        </ul>
                      </div>
                  ...
                  <div class="card nav-tabs-ver-container">
                    <div class="row">
                      <div class="col-lg-3">
                        <ul class="nav nav-tabs-ver nav-tabs-ver-dark" role="tablist">
                          <li class="nav-item">
                            <a class="nav-link active" href="#home9" aria-controls="home9" role="tab" data-toggle="tab">
                              <i class="zmdi zmdi-home"></i> Home</a>
                          </li>
                          <li class="nav-item">
                            <a class="nav-link" href="#profile9" aria-controls="profile9" role="tab" data-toggle="tab">
                              <i class="zmdi zmdi-account"></i> Profile</a>
                          </li>
                          <li class="nav-item">
                            <a class="nav-link" href="#messages9" aria-controls="messages9" role="tab" data-toggle="tab">
                              <i class="zmdi zmdi-email"></i> Messages</a>
                          </li>
                          <li class="nav-item">
                            <a class="nav-link" href="#settings9" aria-controls="settings9" role="tab" data-toggle="tab">
                              <i class="zmdi zmdi-settings"></i> Settings</a>
                          </li>
                        </ul>
                      </div>
                      <div class="col-lg-9 nav-tabs-ver-container-content">
                        <div class="card-body">
                          <div class="tab-content">
                            <div role="tabpanel" class="tab-pane active" id="home9">
                              <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quam soluta, provident similique necessitatibus nihil officiis nam eius dolore ab ad eveniet aliquam est, repellendus reiciendis, perspiciatis aliquid. Voluptatum
                                quasi corporis quisquam autem distinctio, numquam sint. Debitis cumque fugit nulla soluta laudantium sapiente atque a beatae excepturi. Sapiente error temporibus necessitatibus.</p>
                              <p>Facere excepturi qui reiciendis corporis, beatae modi ab distinctio amet adipisci, voluptate error optio. Cupiditate quidem exercitationem sed laudantium. Quasi minima unde soluta optio saepe ipsam! Earum at animi dignissimos
                                accusantium suscipit, placeat voluptates facilis deserunt soluta quam accusamus, iure consectetur quos deleniti porro doloremque aspernatur mollitia.</p>
                  ...
                  <div class="card card-info card-code">
                    ...
                    <div id="code2" class="card-collapse collapse" role="tabpanel" aria-labelledby="codeHead2">
                      <div class="card-code-block"> <pre><code class="language-markup line-numbers">&lt;div class=&quot;card nav-tabs-ver-container&quot;&gt;
    &lt;div class=&quot;row&quot;&gt;
        &lt;div class=&quot;col-lg-3&quot;&gt;
            &lt;ul class=&quot;nav nav-tabs-ver nav-tabs-ver-royal&quot; role=&quot;tablist&quot;&gt;
                &lt;li class=&quot;nav-item&quot;&gt;&lt;a class=&quot;nav-link active&quot; href=&quot;#home&quot; aria-controls=&quot;home&quot; role=&quot;tab&quot; data-toggle=&quot;tab&quot;&gt;&lt;i class=&quot;zmdi zmdi-home&quot;&gt;&lt;/i&gt; Home&lt;/a&gt;&lt;/li&gt;
