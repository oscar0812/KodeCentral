                  ...
                  <ul class="panel-group ms-collapse-nav" id="components-nav" role="tablist" aria-multiselectable="true">
                    ...
                    <li class="card" role="tab" id="e4">
                      ...
                      <ul id="c4" class="panel-collapse collapse show" role="tabpanel" aria-labelledby="e4" data-parent="#components-nav">
                        ...
                        <li>
                          <a class="withripple active" href="component-alerts.php">
                            <i class="zmdi zmdi-info"></i> Alerts &amp; Wells</a>
                        </li>
                        <li>
                          <a class="withripple" href="component-badges.php">
              ...
              <div class="ms-paper-content">
                ...
                <section class="ms-component-section">
                  ...
                  <div class="alert alert-default alert-dismissible" role="alert">
                    ...
                    <strong>
                      <i class="zmdi zmdi-coffee"></i> Default!</strong> Lorem ipsum dolor sit amet, consectetur adipisicing elit. Suscipit, dicta. </div>
                  <div class="alert alert-black alert-dismissible" role="alert">
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                      <i class="zmdi zmdi-close"></i>
                    </button>
                    <strong>
                      <i class="zmdi zmdi-city"></i> Black!</strong> Lorem ipsum dolor sit amet, consectetur adipisicing elit. Suscipit, dicta. </div>
                  <div class="alert alert-primary alert-dismissible" role="alert">
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                      <i class="zmdi zmdi-close"></i>
                    </button>
                    <strong>
                      <i class="zmdi zmdi-notifications"></i> Primary!</strong> Lorem ipsum dolor sit amet, consectetur adipisicing elit. Suscipit, dicta. </div>
                  <div class="alert alert-info alert-dismissible" role="alert">
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                      <i class="zmdi zmdi-close"></i>
                    </button>
                    <strong>
                      <i class="zmdi zmdi-info"></i> Info!</strong> Lorem ipsum dolor sit amet, consectetur adipisicing elit. Suscipit, dicta. </div>
                  <div class="alert alert-success alert-dismissible" role="alert">
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                      <i class="zmdi zmdi-close"></i>
                    </button>
                    <strong>
                      <i class="zmdi zmdi-check"></i> Success!</strong> Lorem ipsum dolor sit amet, consectetur adipisicing elit. Suscipit, dicta. </div>
                  <div class="alert alert-warning alert-dismissible" role="alert">
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                      <i class="zmdi zmdi-close"></i>
                    </button>
                    <strong>
                      <i class="zmdi zmdi-alert-triangle"></i> Warning!</strong> Lorem ipsum dolor sit amet, consectetur adipisicing elit. Suscipit, dicta. </div>
                  <div class="alert alert-danger alert-dismissible" role="alert">
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                      <i class="zmdi zmdi-close"></i>
                    </button>
                    <strong>
                      <i class="zmdi zmdi-close-circle"></i> Error!</strong> Lorem ipsum dolor sit amet, consectetur adipisicing elit. Suscipit, dicta. </div>
                  <div class="alert alert-royal alert-dismissible" role="alert">
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                      <i class="zmdi zmdi-close"></i>
                    </button>
                    <strong>
                      <i class="zmdi zmdi-help-outline"></i> Help!</strong> Lorem ipsum dolor sit amet, consectetur adipisicing elit. Suscipit, dicta. </div>
                  <div class="card card-info card-code">
                    ...
                    <div id="code1" class="card-collapse collapse" role="tabpanel" aria-labelledby="codeHead1">
                      <div class="card-code-block"> <pre><code class="language-markup line-numbers">&lt;div class=&quot;alert alert-default alert-dismissible&quot; role=&quot;alert&quot;&gt;
&lt;/div&gt;
&lt;div class=&quot;alert alert-black alert-dismissible&quot; role=&quot;alert&quot;&gt;
&lt;/div&gt;
&lt;div class=&quot;alert alert-primary alert-dismissible&quot; role=&quot;alert&quot;&gt;
...
&lt;/div&gt;</code></pre> </div>
                ...
                <section class="ms-component-section">
                  <h2 class="section-title">Lights Colors</h2>
                  <div class="alert alert-default alert-light alert-dismissible" role="alert">
                    ...
                    <strong>
                      <i class="zmdi zmdi-coffee"></i> Default!</strong> Lorem ipsum dolor sit amet, consectetur adipisicing elit. Suscipit, dicta. </div>
                  <div class="alert alert-black alert-light alert-dismissible" role="alert">
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                      <i class="zmdi zmdi-close"></i>
                    </button>
                    <strong>
                      <i class="zmdi zmdi-city"></i> Black!</strong> Lorem ipsum dolor sit amet, consectetur adipisicing elit. Suscipit, dicta. </div>
                  <div class="alert alert-primary alert-light alert-dismissible" role="alert">
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                      <i class="zmdi zmdi-close"></i>
                    </button>
                    <strong>
                  ...
                  <div class="card card-info card-code">
                    ...
                    <div id="code2" class="card-collapse collapse" role="tabpanel" aria-labelledby="codeHead2">
                      <div class="card-code-block"> <pre><code class="language-markup line-numbers">&lt;div class=&quot;alert alert-default alert-light alert-dismissible&quot; role=&quot;alert&quot;&gt;
&lt;/div&gt;
&lt;div class=&quot;alert alert-black alert-light alert-dismissible&quot; role=&quot;alert&quot;&gt;
&lt;/div&gt;
&lt;div class=&quot;alert alert-primary alert-light alert-dismissible&quot; role=&quot;alert&quot;&gt;
...
&lt;/div&gt;</code></pre> </div>
                ...
                <section class="ms-component-section">
                  ...
                  <p class="well well-sm">Distinctio, facere quos aperiam fugiat cupiditate delectus inventore nobis quaerat voluptas fugit quibusdam assumenda incidunt consequatur! Explicabo, dolore, cumque eos saepe consequuntur totam excepturi facere voluptatem beatae esse
                    magnam impedit dolorem nihil!</p>
                  <p class="well">Animi, sit, reiciendis voluptas perferendis illo maiores vel a dignissimos mollitia odio doloremque dolores iusto at harum nisi nam atque beatae nobis? Sapiente, cumque aliquid incidunt voluptatem natus architecto ad magnam rerum?</p>
                  <p class="well well-lg">Tempore, molestias, voluptate earum officiis dignissimos facilis corrupti expedita id magnam maxime atque impedit consequuntur incidunt optio dolore quaerat alias modi quisquam ratione rem aut esse fugiat saepe reiciendis deserunt ullam
                    fuga.</p>
                  <div class="card card-info card-code">
                    ...
                    <div id="code3" class="card-collapse collapse" role="tabpanel" aria-labelledby="codeHead3">
                      <div class="card-code-block"> <pre><code class="language-markup line-numbers">&lt;p class=&quot;well well-sm&quot;&gt;Distinctio, facere quos aperiam fugiat cupiditate delectus inventore nobis quaerat voluptas fugit quibusdam assumenda incidunt consequatur! Explicabo, dolore, cumque eos saepe consequuntur totam excepturi facere voluptatem beatae esse magnam impedit dolorem nihil!&lt;/p&gt;
&lt;p class=&quot;well&quot;&gt;Animi, sit, reiciendis voluptas perferendis illo maiores vel a dignissimos mollitia odio doloremque dolores iusto at harum nisi nam atque beatae nobis? Sapiente, cumque aliquid incidunt voluptatem natus architecto ad magnam rerum?&lt;/p&gt;
&lt;p class=&quot;well well-lg&quot;&gt;Tempore, molestias, voluptate earum officiis dignissimos facilis corrupti expedita id magnam maxime atque impedit consequuntur incidunt optio dolore quaerat alias modi quisquam ratione rem aut esse fugiat saepe reiciendis deserunt ullam fuga.&lt;/p&gt;</code></pre>                        </div>
                    </div>
                  </div>
                  <!-- card-code -->
                </section>
