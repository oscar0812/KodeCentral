                  ...
                  <ul class="panel-group ms-collapse-nav" id="components-nav" role="tablist" aria-multiselectable="true">
                    ...
                    <li class="card" role="tab" id="e5">
                      ...
                      <ul id="c5" class="panel-collapse collapse show" role="tabpanel" aria-labelledby="e5" data-parent="#components-nav">
                        ...
                        <li>
                          <a class="withripple active" href="component-audio-video.php">
            ...
            <div class="col-lg-9 ms-paper-content-container">
              <div class="ms-paper-content">
                ...
                <section class="ms-component-section">
                  <h2 class="section-title no-margin-top">Videos</h2>
                  <p class="lead color-danger">Post videos from vimeo, youtube or from your own host.</p>
                  <div class="card">
                    <div data-plyr-provider="youtube" data-plyr-embed-id="bTqVqk7FSmY" class="js-player"></div>
                  </div>
                  <div class="row">
                    <div class="col-md-6">
                      <h3 class="text-center">Vimeo</h3>
                      <div class="card">
                        <div data-plyr-provider="vimeo" data-plyr-embed-id="94747106" class="js-player"></div>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <h3 class="text-center">Youtube</h3>
                      <div class="card">
                        <div data-plyr-provider="youtube" data-plyr-embed-id="9ZfN87gSjvI" class="js-player"></div>
                      </div>
                    </div>
                  </div>
                  <div class="card card-info card-code">
                    ...
                    <div id="code1" class="card-collapse collapse" role="tabpanel" aria-labelledby="codeHead1">
                      <div class="card-code-block"> <pre><code class="language-markup line-numbers">&lt;h3 class=&quot;text-center&quot;&gt;Vimeo&lt;/h3&gt;
&lt;div class=&quot;card&quot;&gt;
...
&lt;/div&gt;</code></pre> </div>
                ...
                <section class="ms-component-section">
                  <h2 class="section-title no-margin-top">Video Cards</h2>
                  <div class="row">
                    <div class="col-md-6">
                      <h3 class="text-center">Basic Card</h3>
                      <div class="card">
                        <div data-plyr-provider="youtube" data-plyr-embed-id="bTqVqk7FSmY" class="js-player"></div>
                    ...
                    <div class="col-md-6">
                      <h3 class="text-center">Whith Color</h3>
                    ...
                    <div class="col-md-6">
                      <h3 class="text-center">Color Inverse</h3>
                    ...
                    <div class="col-md-6">
                      <h3 class="text-center">Reverse Order</h3>
                      <div class="card">
                        <div class="card-body overflow-hidden text-center">
                  ...
                  <div class="card card-info card-code">
                    ...
                    <div id="code2" class="card-collapse collapse" role="tabpanel" aria-labelledby="codeHead2">
                      <div class="card-code-block"> <pre><code class="language-markup line-numbers">&lt;div class=&quot;row&quot;&gt;
    &lt;div class=&quot;col-md-6&quot;&gt;
        &lt;h3 class=&quot;text-center&quot;&gt;With Title&lt;/h3&gt;
        &lt;div class=&quot;card card-danger&quot;&gt;
            &lt;div class=&quot;card-header&quot;&gt;
...
&lt;/div&gt;</code></pre> </div>
                ...
                <section class="ms-component-section">
                  <h2 class="section-title no-margin-top">Audio</h2>
                  <p class="lead color-danger">Play audio easily with the integrated plugin.</p>
                  <h3>Basic</h3>
                  <audio class="js-player" controls>
                    <source src="assets/media/music.mp3" type="audio/mp3">
                    <source src="assets/media/music.ogg" type="audio/ogg"> </audio>
                  <h3>Inside Cards</h3>
                    ...
                    <div class="col-md-6">
                      <div class="card card-warning">
                        ...
                        <div class="card-body overflow-hidden text-center">
                          ...
                          <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ipsam sed labore autem nesciunt ea veniam recusandae necessitatibus reprehenderit.</p>
                          <a href="javascript:void(0)" class="btn btn-warning btn-raised">
                            <i class="zmdi zmdi-cloud-download"></i> Download</a>
                        </div>
                        <audio class="js-player" controls>
                          <source src="assets/media/music.mp3" type="audio/mp3">
                          <source src="assets/media/music.ogg" type="audio/ogg"> </audio>
                  ...
                  <div class="card card-info card-code">
                    ...
                    <div id="code3" class="card-collapse collapse" role="tabpanel" aria-labelledby="codeHead3">
                      <div class="card-code-block"> <pre><code class="language-markup line-numbers">&lt;h3&gt;Basic&lt;/h3&gt;
&lt;audio class=&quot;js-player&quot; controls&gt;
    &lt;source src=&quot;&lt;%= assets %&gt;/media/music.mp3&quot; type=&quot;audio/mp3&quot;&gt;
