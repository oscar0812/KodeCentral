      ...
      <div class="intro-fixed ms-hero-img-airplane ms-hero-bg-royal color-white" id="home">
        <div class="intro-fixed-content index-1">
          <div class="container">
            <div class="row">
              <div class="col-lg-6">
                <div class="text-center mb-4">
                  ...
                  <p class="d-sm-none d-lg-block lead lead-lg color-white center-block mt-2 mb-2 mw-800 text-uppercase fw-300 animated fadeInUp animation-delay-7">Discover our projects and the
            ...
            <div class="text-center mb-2 mt-4 d-md-none d-lg-block">
