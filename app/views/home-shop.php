        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-6 order-lg-2 text-center">
              <img src="assets/img/demo/pixelPro.png" alt="" class="img-fluid animated bounceInRight animation-delay-14"> </div>
            <div class="col-lg-6 order-lg-1">
              ...
              <p class="animated fadeInDown animation-delay-6">It has the highest rated smartphone camera. Ever. A battery that lasts all day. Unlimited storage for all your photos and videos. And it’s the first phone with the Google Assistant built in.</p>
