                  ...
                  <ul class="panel-group ms-collapse-nav" id="components-nav" role="tablist" aria-multiselectable="true">
                    ...
                    <li class="card" role="tab" id="e4">
                      ...
                      <ul id="c4" class="panel-collapse collapse show" role="tabpanel" aria-labelledby="e4" data-parent="#components-nav">
                        ...
                        <li>
                          <a class="withripple active" href="component-carousels.php">
                            <i class="zmdi zmdi-view-carousel"></i> Carousels</a>
                        </li>
                        <li>
                          <a class="withripple" href="component-modals.php">
            ...
            <div class="col-lg-9 ms-paper-content-container">
              <div class="ms-paper-content">
                ...
                <section class="ms-component-section">
                  <h2 class="section-title no-margin-top">Basic Carousel</h2>
                  <div class="card">
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="card card-primary">
                        ...
                        <div id="carousel-example-generic2" class="ms-carousel carousel slide" data-ride="carousel">
                          ...
                          <div class="carousel-inner" role="listbox">
                            <div class="carousel-item active">
                              <img class=" img-fluid" src="assets/img/demo/car1.png" alt="..."> </div>
                            <div class="carousel-item">
                              <img class="d-block img-fluid" src="assets/img/demo/car2.jpg" alt="..."> </div>
                            <div class="carousel-item">
                              <img class="d-block img-fluid" src="assets/img/demo/paris.jpg" alt="..."> </div>
                          </div>
                          <!-- Controls -->
                          <a href="#carousel-example-generic2" class="btn-circle btn-circle-xs btn-circle-raised btn-circle-white color-primary left carousel-control-prev" role="button" data-slide="prev">
                            <i class="zmdi zmdi-chevron-left"></i>
                          </a>
                          <a href="#carousel-example-generic2" class="btn-circle btn-circle-xs btn-circle-raised btn-circle-white color-primary right carousel-control-next" role="button" data-slide="next">
                            <i class="zmdi zmdi-chevron-right"></i>
                          </a>
                        </div>
                    ...
                    <div class="col-lg-6">
                      <div class="card card-warning-inverse">
                        ...
                        <div id="carousel-example-generic3" class="ms-carousel carousel slide" data-ride="carousel">
                          <!-- Wrapper for slides -->
                          <div class="carousel-inner" role="listbox">
                            <div class="carousel-item active">
                              <img class="d-block img-fluid" src="assets/img/demo/car2.jpg" alt="..."> </div>
                            <div class="carousel-item">
                              <img class="d-block img-fluid" src="assets/img/demo/car1.png" alt="..."> </div>
                            <div class="carousel-item">
                              <img class="d-block img-fluid" src="assets/img/demo/paris.jpg" alt="..."> </div>
                          </div>
                          <!-- Controls -->
                          <a href="#carousel-example-generic3" class="btn-circle btn-circle-xs btn-circle-raised btn-circle-warning left carousel-control-prev" role="button" data-slide="prev">
                            <i class="zmdi zmdi-chevron-left"></i>
                          </a>
                          <a href="#carousel-example-generic3" class="btn-circle btn-circle-xs btn-circle-raised btn-circle-warning right carousel-control-next" role="button" data-slide="next">
                            <i class="zmdi zmdi-chevron-right"></i>
                          </a>
                        </div>
                        <div class="card-body overflow-hidden text-center">
                          ...
                          <a href="javascript:void(0)" class="btn btn-white">
                            <i class="zmdi zmdi-star"></i> Button</a>
                          <a href="javascript:void(0)" class="btn btn-raised color-warning">
                            <i class="zmdi zmdi-flower"></i> Button</a>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="card card-info card-code">
                    ...
                    <div id="code1" class="card-collapse collapse" role="tabpanel" aria-labelledby="codeHead1">
                      <div class="card-code-block"> <pre><code class="language-markup line-numbers">&lt;div id=&quot;carousel-example-generic&quot; class=&quot;ms-carousel carousel slide&quot; data-ride=&quot;carousel&quot;&gt;
    &lt;!-- Indicators --&gt;
    &lt;ol class=&quot;carousel-indicators&quot;&gt;
        &lt;li data-target=&quot;#carousel-example-generic&quot; data-slide-to=&quot;0&quot; class=&quot;active&quot;&gt;&lt;/li&gt;
        &lt;li data-target=&quot;#carousel-example-generic&quot; data-slide-to=&quot;1&quot;&gt;&lt;/li&gt;
...
&lt;/div&gt;</code></pre> </div>
                ...
                <section class="ms-component-section">
                  <h2 class="section-title no-margin-top">Thumbnails Indicators</h2>
                  <div class="card">
                    <div id="carousel-example-generic4" class="ms-carousel ms-carousel-thumb carousel slide" data-ride="carousel">
                      ...
                      <ol class="carousel-indicators carousel-indicators-tumbs">
                        <li data-target="#carousel-example-generic4" data-slide-to="0" class="active">
                          <img class="" src="assets/img/demo/car1-thumb.png" alt=""> </li>
                        <li data-target="#carousel-example-generic4" data-slide-to="1">
                          <img class="" src="assets/img/demo/car2-thumb.jpg" alt=""> </li>
                        <li data-target="#carousel-example-generic4" data-slide-to="2">
                          <img class="" src="assets/img/demo/paris-thumb.png" alt=""> </li>
                      </ol>
                      <!-- Wrapper for slides -->
                      <div class="carousel-inner" role="listbox">
                        <div class="carousel-item active">
                  ...
                  <div class="card card-info card-code">
                    ...
                    <div id="code2" class="card-collapse collapse" role="tabpanel" aria-labelledby="codeHead2">
                      <div class="card-code-block"> <pre><code class="language-markup line-numbers">&lt;div id=&quot;carousel-example-generic4&quot; class=&quot;ms-carousel ms-carousel-thumb carousel slide&quot; data-ride=&quot;carousel&quot;&gt;
    &lt;!-- Indicators --&gt;
    &lt;ol class=&quot;carousel-indicators carousel-indicators-tumbs&quot;&gt;
        &lt;li data-target=&quot;#carousel-example-generic4&quot; data-slide-to=&quot;0&quot; class=&quot;active&quot;&gt;
...
&lt;/div&gt;
                ...
                <section class="ms-component-section">
                  <h2 class="section-title no-margin-top">Thumbnails Indicators Outside</h2>
                  <div id="carousel-example-generic5" class="ms-carousel ms-carousel-thumb carousel slide" data-ride="carousel">
                    <div class="card card-relative">
                      ...
                      <!-- Controls -->
                      <a href="#carousel-example-generic5" class="btn-circle btn-circle-xs btn-circle-raised btn-circle-primary left carousel-control-prev" role="button" data-slide="prev">
                        <i class="zmdi zmdi-chevron-left"></i>
                      </a>
                      <a href="#carousel-example-generic5" class="btn-circle btn-circle-xs btn-circle-raised btn-circle-primary right carousel-control-next" role="button" data-slide="next">
                        <i class="zmdi zmdi-chevron-right"></i>
                      </a>
                    </div>
                    <!-- Indicators -->
                  ...
                  <div class="card card-info card-code">
                    ...
                    <div id="code3" class="card-collapse collapse" role="tabpanel" aria-labelledby="codeHead3">
                      <div class="card-code-block"> <pre><code class="language-markup line-numbers">&lt;div id=&quot;carousel-example-generic5&quot; class=&quot;ms-carousel ms-carousel-thumb carousel slide&quot; data-ride=&quot;carousel&quot;&gt;
    &lt;div class=&quot;card card-relative&quot;&gt;
        &lt;!-- Wrapper for slides --&gt;
        &lt;div class=&quot;carousel-inner&quot; role=&quot;listbox&quot;&gt;
            &lt;div class=&quot;carousel-item active&quot;&gt;
...
&lt;/div&gt;</code></pre> </div>
                ...
                <section class="ms-component-section">
                  <h2 class="section-title no-margin-top">Owl Carousel</h2>
                  ...
                  <div class="owl-carousel owl-theme">
                    <div class="card card-primary animation-delay-5">
                      ...
                      <div class="card-body"> Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quasi cumque, vero odit, distinctio provident dolorem ullam laboriosam! Nisi asperiores unde error, reiciendis numquam! Numquam corporis incidunt doloremque repellat reiciendis,
                        sit. </div>
                    </div>
                  ...
                  <div class="card card-info card-code">
                    ...
                    <div id="code4" class="card-collapse collapse" role="tabpanel" aria-labelledby="codeHead4">
                      <div class="card-code-block"> <pre><code class="language-markup line-numbers">&lt;div class=&quot;owl-dots&quot;&gt;&lt;/div&gt;
&lt;div class=&quot;owl-carousel owl-theme&quot;&gt;
    &lt;div class=&quot;card card-primary animation-delay-5&quot;&gt;
        &lt;img class=&quot;owl-lazy&quot; data-src=&quot;&lt;%= assets %&gt;/img/demo/port1.jpg&quot; alt=&quot;&quot; class=&quot;img-fluid&quot;&gt;
        &lt;div class=&quot;card-body&quot;&gt;
