                  ...
                  <ul class="panel-group ms-collapse-nav" id="components-nav" role="tablist" aria-multiselectable="true">
                    <li class="card" role="tab" id="e1">
                      ...
                      <ul id="c1" class="panel-collapse collapse show" role="tabpanel" aria-labelledby="e1" data-parent="#components-nav">
                        ...
                        <li>
                          <a class="withripple active" href="component-tables.php">
                            <i class="fa fa-table"></i> Tables</a>
                        </li>
                      </ul>
                    </li>
            ...
            <div class="col-lg-9 ms-paper-content-container">
              <div class="ms-paper-content">
                ...
                <section class="ms-component-section">
                  ...
                  <p>For basic styling&mdash;light padding and only horizontal dividers&mdash;add the base class <code>.table</code> to any <code>&lt;table&gt;</code>. It may seem super redundant, but given the widespread use of tables for other plugins
                    like calendars and date pickers, we've opted to isolate our custom table styles.</p>
                  ...
                  <div class="card card-info card-code">
                    ...
                    <div id="code2" class="card-collapse collapse" role="tabpanel" aria-labelledby="codeHead2">
                      <div class="card-code-block"> <pre><code class="language-markup line-numbers">&lt;table class=&quot;table&quot;&gt;
    &lt;thead&gt;
        &lt;tr&gt;
            &lt;th&gt;#&lt;/th&gt;
            ...
...
&lt;/div&gt;
                  ...
                  <p>Create responsive tables by wrapping any <code>.table</code> in <code>.table-responsive</code> to make them scroll horizontally up to small devices (under 768px). When viewing on anything larger than 768px wide, you will not see any
