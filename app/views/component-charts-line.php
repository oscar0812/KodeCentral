                  ...
                  <ul class="panel-group ms-collapse-nav" id="components-nav" role="tablist" aria-multiselectable="true">
                    ...
                    <li class="card" role="tab" id="e7">
                      ...
                      <ul id="c7" class="panel-collapse collapse show" role="tabpanel" aria-labelledby="e7" data-parent="#components-nav">
                        ...
                        <li>
                          <a class="withripple active" href="component-charts-line.php">
                            <i class="fa fa-line-chart"></i> Line Charts</a>
                        </li>
                        <li>
                          <a class="withripple" href="component-charts-more.php">
            ...
            <div class="col-lg-9 ms-paper-content-container">
              <div class="ms-paper-content">
                ...
                <section class="ms-component-section">
                  <h2 class="section-title no-margin-top">Basic Line Chart</h2>
                  <canvas id="myChart"></canvas>
                </section>
                <section class="ms-component-section">
                  <h2 class="section-title no-margin-top">Real Time</h2>
                    ...
                    <div class="col-lg-6">
                      <div class="card card-primary">
                        ...
                        <div class="card-body overflow-hidden text-center">
                          <h3 class="color-primary ">Lorem ipsum dolor sit</h3>
                          <p>Rerum reiciendis soluta pariatur vitae, exercitationem dolorem nulla. Omnis blanditiis deleniti aliquid nemo odit quod ex laudantium itaque sed.</p>
                          <a href="javascript:void(0)" class="btn btn-raised btn-primary">
                            <i class="zmdi zmdi-chart"></i> Button</a>
                        </div>
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="card card-warning">
                        ...
                        <div class="card-body overflow-hidden text-center">
                          <h3 class="color-warning ">Lorem ipsum dolor sit</h3>
                          <p>Rerum reiciendis soluta pariatur vitae, exercitationem dolorem nulla. Omnis blanditiis deleniti aliquid nemo odit quod ex laudantium itaque sed.</p>
                          <a href="javascript:void(0)" class="btn btn-raised btn-warning">
                            <i class="zmdi zmdi-chart"></i> Button</a>
                        </div>
                      </div>
                    </div>
                ...
                <section class="ms-component-section">
                  <h2 class="section-title no-margin-top">More Options</h2>
