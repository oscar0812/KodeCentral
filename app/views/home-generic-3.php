...
<html lang="en">
  ...
  <body>
    ...
    <div class="ms-site-container">
      ...
      <div class="wrap bg-info">
        <div class="container">
          <div class="text-center color-white mw-800 center-block mb-4">
            ...
            <p class="lead wow fadeInDown animation-delay-5"> Lorem ipsum dolor sit amet,
              <span class="">consectetur adipisicing</span> elit. Dolor alias provident excepturi eligendi, nam numquam iusto eum illum, ea quisquam.</p>
          </div>
      ...
      <!-- container -->
      <section class="wrap bg-primary mt-6">
        <div class="container">
          <div class="row">
      ...
      <section class="mt-6">
        <div class="container">
          <h2 class="color-primary right-line">Recent Works</h2>
          <div class="row">
      ...
      <section class="wrap ms-hero-img-team ms-hero-bg-dark-light ms-bg-fixed">
        <div class="text-center color-whit index-1">
          <h1 class="no-m ms-site-title center-block ms-site-title-lg mt-2 animated zoomInDown animation-delay-5">Our Clients</h1>
              ...
              <div class="card card-warning wow zoomInUp animation-delay-5">
                <div class="text-center bg-warning">
                  <a href="javascript:void()" class="">
                    <img src="assets/img/demo/nokia.png" alt="..." class="">
                  </a>
                </div>
                <div class="card-body overflow-hidden text-center">
                  <h3 class="color-warning">Nokia</h3>
                  ...
                  <a href="javascript:void(0)" class="btn btn-warning">
                    <i class="zmdi zmdi-link"></i> Website</a>
                </div>
              </div>
            </div>
            <div class="col-lg-4 col-md-6">
              <div class="card card-info wow zoomInUp animation-delay-5">
                <div class="text-center bg-info">
                  <a href="javascript:void()" class="">
                    <img src="assets/img/demo/microsoft.png" alt="..." class="">
                  </a>
                </div>
                <div class="card-body overflow-hidden text-center">
                  <h3 class="color-info">Microsoft</h3>
                  <p>Lorem ipsum dolor sit amet, consectetur alter adipisicing elit. Facilis, natuse inse voluptates officia repudiandae beatae magni es magnam autem molestias.</p>
            ...
            <div class="col-lg-4 col-md-6">
              <div class="card card-success wow zoomInUp animation-delay-5">
                <div class="text-center bg-success">
                  <a href="javascript:void()" class="">
                    <img src="assets/img/demo/intel.png" alt="..." class="">
                  </a>
                </div>
                <div class="card-body overflow-hidden text-center">
                  <h3 class="color-success">Intel</h3>
                  <p>Lorem ipsum dolor sit amet, consectetur alter adipisicing elit. Facilis, natuse inse voluptates officia repudiandae beatae magni es magnam autem molestias.</p>
        ...
        <div class="text-center index-1 mt-2">
          <a href="javascript:void(0)" class="btn btn-danger btn-xlg btn-raised">
            <i class="zmdi zmdi-accounts"></i> All Clients</a>
        </div>
      </section>
      <div class="container mt-6">
        ...
        <div class="row">
          <div class="col-lg-6">
            ...
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Repellat cum laudantium quos tempora magnam voluptas sint perspiciatis nulla ipsa itaque atque quod incidunt maiores iusto, laborum, magni aliquam. Aut eligendi nesciunt nobis eum dolorum
              maxime corporis dicta, repudiandae eveniet ab laboriosam minima voluptate quaerat sequi modi suscipit cumque unde rerum.</p>
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Debitis porro, magni obcaecati cupiditate nulla rem quae, eveniet corrupti reprehenderit maiores nobis doloribus expedita non quasi itaque. Incidunt, delectus quidem vitae laudantium,
          ...
          <div class="col-lg-6">
            <h3 class="color-primary">Knowledge</h3>
    ...
    <script src="assets/js/home-generic-3.js"></script>
  </body>
</html>