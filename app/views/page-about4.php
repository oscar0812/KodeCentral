        ...
        <div class="card card-body mt-6 card-body-big wow fadeInUp">
          ...
          <ul class="ms-timeline-left">
            ...
            <li class="ms-timeline-left-item wow fadeInUp">
              <h4>Microsoft</h4>
              <div class="ms-timeline-left-left">
                <h4 class="color-primary">Android App</h4>
                <time class="ms-timeline-left-time">2015 - 2016</time>
              </div>
            ...
            <li class="ms-timeline-left-item wow fadeInUp">
              <h4>Twitter</h4>
              <div class="ms-timeline-left-left">
                <h4 class="color-primary">Consulting Work</h4>
                <time class="ms-timeline-left-time">2015 - 2016</time>
              </div>
            ...
            <li class="ms-timeline-left-item wow fadeInUp">
              ...
              <div class="ms-timeline-left-left">
                <h4 class="color-primary">Promotional Website</h4>
                <time class="ms-timeline-left-time">2015 - 2016</time>
              </div>
            ...
            <li class="ms-timeline-left-item wow fadeInUp">
              <h4>AGM Studio</h4>
              <div class="ms-timeline-left-left">
                <h4 class="color-primary">Business Project</h4>
                <time class="ms-timeline-left-time">2015 - 2016</time>
              </div>
          ...
          <div class="card-body card-body-big">
            ...
            <div class="row d-flex justify-content-center">
              <div class="col-lg-4 col-md-6">
                <div class="card card-flat mt-4 card-danger wow zoomInUp">
