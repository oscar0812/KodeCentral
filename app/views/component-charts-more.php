...
<html lang="en">
  ...
  <body>
                  ...
                  <ul class="panel-group ms-collapse-nav" id="components-nav" role="tablist" aria-multiselectable="true">
                    ...
                    <li class="card" role="tab" id="e7">
                      ...
                      <ul id="c7" class="panel-collapse collapse show" role="tabpanel" aria-labelledby="e7" data-parent="#components-nav">
                        ...
                        <li>
                          <a class="withripple active" href="component-charts-more.php">
                            <i class="fa fa-pie-chart"></i> More Charts</a>
                        </li>
                      </ul>
                    </li>
            ...
            <div class="col-lg-9 ms-paper-content-container">
              <div class="ms-paper-content">
                ...
                <div class="alert alert-warning alert-light">
                  ...
                  <strong>Info:</strong> The sample data is generated with random numbers. Recharge your browser to see new graphics. </div>
                <section class="ms-component-section">
                  <h2 class="section-title no-margin-top">Pie &amp; Doughnut Charts</h2>
                  <div class="row">
                    <div class="col-md-6">
                      <h3 class="text-center">Pie Charts</h3>
                      <canvas id="myChart1"></canvas>
                      <hr class="dotted">
                      <canvas id="myChart3"></canvas>
                    </div>
                    <div class="col-md-6">
                      <h3 class="text-center">Doughnut Charts</h3>
                ...
                <section class="ms-component-section">
                  <h2 class="section-title no-margin-top">Polar Area Charts</h2>
                  <canvas id="myChart5"></canvas>
                </section>
                <section class="ms-component-section">
                  <h2 class="section-title no-margin-top">Radar Chart</h2>
                  <canvas id="myChart7"></canvas>
                </section>
                <section class="ms-component-section">
                  <h2 class="section-title no-margin-top">Bubble Chart</h2>
    ...
    <script src="assets/js/charts-more.js"></script>
  </body>
</html>