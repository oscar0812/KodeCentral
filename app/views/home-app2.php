  ...
  <body>
    ...
    <div class="ms-site-container">
      ...
      <header class="ms-hero-page-bottom bg-primary-dark">
        <div class="container">
          <div class="row">
            <div class="col-xl-6 col-lg-7 hero-img-col">
              <div class="text-center color-white">
                <h1 class="animated fadeInDown animation-delay-6">Google Pixel</h1>
                <p class="lead lead-xl animated fadeInDown animation-delay-4">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Facilis omnis quod inventore officiis nulla nihil.</p>
              </div>
              <ol class="service-list service-list-white service-list-border list-unstyled">
                <li class="animated fadeInLeft animation-delay-3">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nihil suscipit cupiditate expedita hic earum vero sint, recusandae itaque, rem distinctio.</li>
                <li class="animated fadeInLeft animation-delay-5">Totam porro sit, obcaecati quos quae iure tenetur, soluta voluptatem sapiente rerum ipsam delectus corporis voluptates voluptate, nulla mollitia pariatur.</li>
                <li class="animated fadeInLeft animation-delay-7">Amet dolorum ullam, rerum ratione distinctio, quia iusto rem! Asperiores et quas, ratione in dolores dolorum doloribus magni suscipit labore obcaecati quos quae iure tenetur.</li>
              </ol>
            </div>
            <div class="col-xl-6 col-lg-5 text-center mt-6">
          ...
          <div class="row">
            <div class="d-flex flex-wrap justify-content-center justify-content-lg-between text-center col mb-4">
              <a href="javascript:void(0)" class="btn btn-white color-primary btn-raised btn-app wow zoomInUp animation-delay-2">
              ...
              <a href="javascript:void(0)" class="btn btn-white color-primary btn-raised btn-app wow zoomInUp animation-delay-3">
                <div class="btn-container">
      ...
      <div class="wrap ms-hero-img-beach ms-hero-bg-info ms-bg-fixed mt-6">
        <div class="container">
          <div class="text-center mb-4">
            <h2 class="color-white">Knows the
              <span class="text-normal">Material Style</span> and surprise yourself</h2>
            <p class="lead color-info">Put here a short description or brief highlights in your app.</p>
          </div>
          <div class="mw-800 center-block">
            <ul class="nav nav-tabs nav-tabs-warning nav-tabs-full nav-tabs-3" role="tablist">
              ...
              <div role="tabpanel" class="tab-pane fade" id="windows">
                <div class="row">
                  <div class="col-lg-6 col-xl-5 order-lg-2">
                    <ul class="list-unstyled hand-list color-light">
                      <li class="mb-3 animated fadeInLeft animation-delay-2">
                      ...
                      <li class="mb-3 animated fadeInLeft animation-delay-4">
                        <h2 class="handwriting no-mt color-primary no-mb">Type here annotations</h2>
                        <p class="lead handwriting">Lorem ipsum dolor sit amet, consectetur adipisicing elit provident tempore porro deserunt nostrum sapiente.</p>
                      </li>
                      <li class="mb-3 animated fadeInLeft animation-delay-6">
              ...
              <div role="tabpanel" class="tab-pane active show fade" id="macos">
                <div class="row">
                  <div class="col-lg-6 col-xl-5">
                    <ul class="list-unstyled hand-list color-light">
                      <li class="mb-3 wow fadeInLeft animation-delay-2">
                        <h2 class="handwriting no-mt color-primary no-mb">Ideas for your product</h2>
                        <p class="lead handwriting">Lorem ipsum dolor sit amet, consectetur adipisicing elit provident tempore porro deserunt nostrum sapiente.</p>
                      </li>
                      <li class="mb-3 wow fadeInLeft animation-delay-4">
                        <h2 class="handwriting no-mt color-primary no-mb">Type here annotations</h2>
                        <p class="lead handwriting">Lorem ipsum dolor sit amet, consectetur adipisicing elit provident tempore porro deserunt nostrum sapiente.</p>
                      </li>
                      <li class="mb-3 wow fadeInLeft animation-delay-6">
                        <h2 class="handwriting no-mt color-primary no-mb">An informal approach to design</h2>
                        <p class="lead handwriting">Lorem ipsum dolor sit amet, consectetur adipisicing elit provident tempore porro deserunt nostrum.</p>
                      </li>
                    </ul>
