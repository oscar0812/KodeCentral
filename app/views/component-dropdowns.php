                  ...
                  <ul class="panel-group ms-collapse-nav" id="components-nav" role="tablist" aria-multiselectable="true">
                    ...
                    <li class="card" role="tab" id="e4">
                      ...
                      <ul id="c4" class="panel-collapse collapse show" role="tabpanel" aria-labelledby="e4" data-parent="#components-nav">
                        ...
                        <li>
                          <a class="withripple active" href="component-dropdowns.php">
                            <i class="fa fa-info"></i> Dropdowns</a>
                        </li>
                      </ul>
                    </li>
            ...
            <div class="col-lg-9 ms-paper-content-container">
              <div class="ms-paper-content">
                ...
                <section class="ms-component-section">
                  <h2 class="section-title no-margin-top">Center Dropdowns</h2>
                  <!-- Single button -->
                  <div class="btn-group">
                    ...
                    <ul class="dropdown-menu dropdown-menu-primary">
                      ...
                      <li>
                        <a class="dropdown-item" href="javascript:void(0)">
                          <i class="zmdi zmdi-home"></i>Action</a>
                      </li>
                      <li>
                        <a class="dropdown-item" href="javascript:void(0)">
                          <i class="zmdi zmdi-info"></i>Another action</a>
                      </li>
                      <li>
                        <a class="dropdown-item" href="javascript:void(0)">
                          <i class="zmdi zmdi-star"></i>Something else here</a>
                      </li>
                      <li role="separator" class="dropdown-divider"></li>
                      <li>
                        <a class="dropdown-item" href="javascript:void(0)">
                          <i class="zmdi zmdi-edit"></i>Separated link</a>
                      </li>
                    </ul>
                  </div>
                  <!-- Single button -->
...
&lt;/div&gt;
                ...
                <section class="ms-component-section">
                  <h2 class="section-title no-margin-top">Right Dropdowns</h2>
                  <!-- Split button -->
                  <div class="btn-group">
                  ...
                  <div class="btn-group">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right dropdown-menu-info">
                      <li class="dropdown-header">Button</li>
                      <li>
                        <a class="dropdown-item" href="javascript:void(0)">Action</a>
                      </li>
                  ...
                  <div class="btn-group">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right dropdown-menu-danger">
                      <li class="dropdown-header">Button</li>
                      <li>
                        <a class="dropdown-item" href="javascript:void(0)">Action</a>
                      </li>
                  ...
                  <div class="btn-group">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right dropdown-menu-warning">
                      <li class="dropdown-header">Button</li>
                      <li>
                        <a class="dropdown-item" href="javascript:void(0)">Action</a>
                      </li>
                  ...
                  <div class="btn-group">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right dropdown-menu-success">
                      <li class="dropdown-header">Button</li>
                      <li>
                        <a class="dropdown-item" href="javascript:void(0)">Action</a>
                      </li>
                  ...
                  <div class="btn-group">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right dropdown-menu-royal">
                      <li class="dropdown-header">Button</li>
                      <li>
                        <a class="dropdown-item" href="javascript:void(0)">Action</a>
                      </li>
                  ...
                  <div class="card card-info card-code">
                    ...
                    <div id="code2" class="card-collapse collapse" role="tabpanel" aria-labelledby="codeHead2">
                      <div class="card-code-block"> <pre><code class="language-markup line-numbers">&lt;div class=&quot;btn-group&quot;&gt;
    &lt;button type=&quot;button&quot; class=&quot;btn btn-default btn-raised&quot;&gt;Button&lt;/button&gt;
    &lt;button type=&quot;button&quot; class=&quot;btn btn-default btn-raised dropdown-toggle&quot; data-toggle=&quot;dropdown&quot; aria-haspopup=&quot;true&quot; aria-expanded=&quot;false&quot;&gt;
        &lt;i class=&quot;zmdi zmdi-chevron-down right only&quot;&gt;&lt;/i&gt;
    &lt;/button&gt;
...
&lt;/div&gt;
                ...
                <section class="ms-component-section">
                  <h2 class="section-title no-margin-top">Left Dropdowns</h2>
                  <!-- Split button -->
                  <div class="btn-group">
                    <button type="button" class="btn btn-default btn-raised dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                      <i class="zmdi zmdi-chevron-down right only"></i>
                  ...
                  <div class="btn-group">
                    ...
                    <ul class="dropdown-menu dropdown-menu-left dropdown-menu-info">
                      <li class="dropdown-header">Button</li>
                      <li>
                        <a class="dropdown-item" href="javascript:void(0)">Action</a>
                      </li>
                  ...
                  <div class="btn-group">
                    ...
                    <ul class="dropdown-menu dropdown-menu-left dropdown-menu-danger">
                      <li class="dropdown-header">Button</li>
                      <li>
                        <a class="dropdown-item" href="javascript:void(0)">Action</a>
                      </li>
                  ...
                  <div class="btn-group">
                    ...
                    <ul class="dropdown-menu dropdown-menu-left dropdown-menu-warning">
                      <li class="dropdown-header">Button</li>
                      <li>
                        <a class="dropdown-item" href="javascript:void(0)">Action</a>
                      </li>
                  ...
                  <div class="btn-group">
                    ...
                    <ul class="dropdown-menu dropdown-menu-left dropdown-menu-success">
                      <li class="dropdown-header">Button</li>
                      <li>
                        <a class="dropdown-item" href="javascript:void(0)">Action</a>
                      </li>
                  ...
                  <div class="btn-group">
                    ...
                    <ul class="dropdown-menu dropdown-menu-left dropdown-menu-royal">
                      <li class="dropdown-header">Button</li>
                      <li>
                        <a class="dropdown-item" href="javascript:void(0)">Action</a>
                      </li>
