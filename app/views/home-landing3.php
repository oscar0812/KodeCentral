  ...
  <body>
    ...
    <div class="ms-site-container ms-nav-fixed">
      ...
      <div class="intro-full ms-hero-img-city2 ms-hero-bg-primary color-white" id="home">
        <div id="intro-video" class="" class="js-player" data-plyr-provider="youtube" data-plyr-embed-id="V-FgQ2NAGFc" data-plyr='{ "autoplay": true, "volume": 0, "controls": [], "loop": true }'></div>
                    ...
                    <figure class="ms-thumbnail ms-thumbnail-top ms-thumbnail-info">
                      ...
                      <figcaption class="ms-thumbnail-caption text-center">
                        <div class="ms-thumbnail-caption-content">
                          ...
                          <a href="javascript:void(0)" class="btn btn-raised btn-white color-primary btn-sm">
          ...
          <div class="wrap ms-hero-img-airplane ms-hero-bg-royal ms-bg-fixed">
            <div class="container">
              ...
              <div class="row no-gutters">
                <div class="col-lg-4">
                  <div class="price-table price-table-info wow zoomInUp">
                ...
                <div class="col-lg-4">
                  <div class="price-table price-table-success prominent wow zoomInDown">
                    <header class="price-table-header">
                ...
                <div class="col-lg-4">
                  <div class="price-table price-table-warning wow zoomInUp">
                    <header class="price-table-header">
    ...
    <div class="ms-slidebar sb-slidebar sb-left sb-momentum-scrolling sb-style-overlay">
      ...
      <ul class="ms-slidebar-menu" id="slidebar-menu" role="tablist" aria-multiselectable="true">
        ...
        <li>
          <a data-scroll class="link" href="index.php">
