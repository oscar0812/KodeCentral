          ...
          <div class="row">
                  ...
                  <ul class="panel-group ms-collapse-nav" id="components-nav" role="tablist" aria-multiselectable="true">
                    ...
                    <li class="card" role="tab" id="e4">
                      ...
                      <ul id="c4" class="panel-collapse collapse show" role="tabpanel" aria-labelledby="e4" data-parent="#components-nav">
                        ...
                        <li>
                          <a class="withripple active" href="component-thumbnails.php">
                            <i class="zmdi zmdi-image-o"></i> Thumbnails</a>
                          </a>
                        </li>
                        <li>
            ...
            <div class="col-lg-9 ms-paper-content-container">
              <div class="ms-paper-content">
                <h1>Thumbnails Components</h1>
                <div class="alert alert-light alert-info">
                  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                    <i class="zmdi zmdi-close"></i>
                  </button>
                  <i class="fa fa-info"></i> You can also find thumbnails
                  <a href="component-composite-cards.php">inside cards</a>. </div>
                <section class="ms-component-section">
                  <h2 class="section-title no-margin-top">Basic Thumbnails</h2>
                  <div class="row">
                    <div class="col-md-6">
                      <a href="javascript:void(0)" class="img-thumbnail withripple">
                        <div class="thumbnail-container">
                          <img src="assets/img/demo/port2.jpg" alt="..." class="img-fluid"> </div>
                      </a>
                    </div>
                    <div class="col-md-6">
                      <a href="javascript:void(0)" class="img-thumbnail withripple color-light">
                        <div class="thumbnail-container">
                          <img src="assets/img/demo/port3.jpg" alt="..." class="img-fluid"> </div>
                      </a>
                    </div>
                  </div>
                  <h3>With Ripple Colors</h3>
                  <div class="row">
                    <div class="col-md-4">
                      <a href="javascript:void(0)" class="img-thumbnail withripple color-danger">
                        <div class="thumbnail-container">
                          <img src="assets/img/demo/port4.jpg" alt="..." class="img-fluid"> </div>
                      </a>
                    </div>
                    <div class="col-md-4">
                      <a href="javascript:void(0)" class="img-thumbnail withripple color-warning">
                        <div class="thumbnail-container">
                          <img src="assets/img/demo/port5.jpg" alt="..." class="img-fluid"> </div>
                      </a>
                    </div>
                    <div class="col-md-4">
                      <a href="javascript:void(0)" class="img-thumbnail withripple color-royal">
                        <div class="thumbnail-container">
                          <img src="assets/img/demo/port6.jpg" alt="..." class="img-fluid"> </div>
                      </a>
                    </div>
                    <div class="col-md-4">
                      <a href="javascript:void(0)" class="img-thumbnail withripple color-info">
                        <div class="thumbnail-container">
                          <img src="assets/img/demo/port1.jpg" alt="..." class="img-fluid"> </div>
                      </a>
                    </div>
                    <div class="col-md-4">
                      <a href="javascript:void(0)" class="img-thumbnail withripple color-success">
                        <div class="thumbnail-container">
                          <img src="assets/img/demo/port7.jpg" alt="..." class="img-fluid"> </div>
                      </a>
                    </div>
                    <div class="col-md-4">
                      <a href="javascript:void(0)" class="img-thumbnail withripple color-dark">
                        <div class="thumbnail-container">
                          <img src="assets/img/demo/port8.jpg" alt="..." class="img-fluid"> </div>
                      </a>
                    </div>
                  </div>
                  <div class="card card-info card-code">
                    ...
                    <div id="code1" class="card-collapse collapse" role="tabpanel" aria-labelledby="codeHead1">
                      <div class="card-code-block"> <pre><code class="language-markup line-numbers">&lt;a href=&quot;#&quot; class=&quot;img-thumbnail withripple&quot;&gt;
    &lt;div class=&quot;thumbnail-container&quot;&gt;
...
&lt;/a&gt;
                ...
                <section class="ms-component-section">
                  <h2 class="section-title no-margin-top">Custom content</h2>
                  <div class="row">
                    <div class="col-md-6">
                      <div class="img-thumbnail">
                        ...
                        <div class="caption">
                          ...
                          <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Obcaecati inventore praesentium natus iure nam suscipit exercitationem facere nemo.</p>
                          <div class="text-center">
                            <a href="javascript:void(0)" class="btn btn-primary btn-sm" role="button">
                              <i class="zmdi zmdi-account"></i> Button</a>
                            <a href="javascript:void(0)" class="btn btn-primary btn-sm btn-raised" role="button">
                    ...
                    <div class="col-md-6">
                      <div class="img-thumbnail">
                        ...
                        <div class="caption">
                          <h3 class="color-success">Thumbnail label</h3>
                          <p>Cras justo odio egestas eget quam. Donec id elit non mi porta gravida at eget metus. Nullam id dolor id nibh ultricies vehicula ut id elit.</p>
                          <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Obcaecati inventore praesentium natus iure nam suscipit exercitationem facere nemo.</p>
                          <div class="text-center">
                            <a href="javascript:void(0)" class="btn btn-success btn-sm btn-raised" role="button">
                              <i class="zmdi zmdi-star"></i> Button</a>
                          </div>
                        </div>
                      </div>
                ...
                <section class="ms-component-section">
                  <h2 class="section-title no-margin-top">Thumbnails with hover caption</h2>
                  <div class="row">
                    ...
                    <div class="col-sm-6 mb-2">
                      ...
                      <div class="ms-thumbnail-container">
                        <figure class="ms-thumbnail ms-thumbnail-horizontal">
                          ...
                          <figcaption class="ms-thumbnail-caption text-center">
                            <div class="ms-thumbnail-caption-content">
                              <h3 class="ms-thumbnail-caption-title">Caption Title</h3>
                              <p>Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
                              <a href="javascript:void(0)" class="btn-circle btn-circle-raised mr-1 btn-circle-white color-danger">
                                <i class="zmdi zmdi-favorite"></i>
                                <span class="badge-pill badge-pill-danger">12</span>
                              </a>
                              <a href="javascript:void(0)" class="btn-circle btn-circle-raised ml-1 mr-1 btn-circle-white color-warning">
                                <i class="zmdi zmdi-star"></i>
                                <span class="badge-pill badge-pill-warning">6</span</a>
                                  <a href="javascript:void(0)" class="btn-circle btn-circle-raised ml-1 btn-circle-white color-success">
                                    <i class="zmdi zmdi-download"></i>
                                    <span class="badge-pill badge-pill-success">5682</span>
                                  </a>
                            </div>
                          </figcaption>
                        </figure>
                  ...
                  <div class="row">
                        ...
                        <figure class="ms-thumbnail ms-thumbnail-center ms-thumbnail-warning">
                          ...
                          <figcaption class="ms-thumbnail-caption text-center">
                            <div class="ms-thumbnail-caption-content">
                              <h3 class="ms-thumbnail-caption-title">Lorem ipsum dolor sit</h3>
                              <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p>
                              <a href="javascript:void(0)" class="btn btn-white btn-raised color-warning">
                                <i class="zmdi zmdi-eye"></i> View more</a>
                            </div>
                          </figcaption>
                        </figure>
                    ...
                    <div class="col-sm-6 mb-2">
                      <h3 class="text-center">Danger</h3>
                      <div class="ms-thumbnail-container">
                        <figure class="ms-thumbnail ms-thumbnail-right ms-thumbnail-danger">
                  ...
                  <div class="row">
                    <div class="col-sm-6 mb-2">
                      ...
                      <div class="ms-thumbnail-container">
                        <figure class="ms-thumbnail ms-thumbnail-diagonal ms-thumbnail-info">
                          <img src="assets/img/demo/port6.jpg" alt="" class="img-fluid">
                          <figcaption class="ms-thumbnail-caption text-center">
                            <div class="ms-thumbnail-caption-content">
                              <h3 class="ms-thumbnail-caption-title color-warning">Lorem ipsum dolor sit</h3>
                              <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p>
                              <a href="javascript:void(0)" class="btn btn-white btn-raised color-warning">
                                <i class="zmdi zmdi-eye"></i> View more</a>
                            </div>
                    ...
                    <div class="col-sm-6 mb-2">
                      ...
                      <div class="ms-thumbnail-container">
                        <figure class="ms-thumbnail ms-thumbnail-bottom ms-thumbnail-royal">
                  ...
                  <div class="row">
                    <div class="col-sm-6 mb-2">
                      ...
                      <div class="ms-thumbnail-container">
                        <figure class="ms-thumbnail ms-thumbnail-left ms-thumbnail-success">
                    ...
                    <div class="col-sm-6 mb-2">
                      <h3 class="text-center">Dark</h3>
                      <div class="ms-thumbnail-container">
                        <figure class="ms-thumbnail ms-thumbnail-dark">
                  ...
                  <div class="row">
                    <div class="col-sm-6 mb-2">
                      ...
                      <div class="ms-thumbnail-container">
                        <figure class="ms-thumbnail ms-thumbnail-horizontal ms-thumbnail-light">
                          ...
                          <figcaption class="ms-thumbnail-caption text-center">
                            <div class="ms-thumbnail-caption-content">
                              <h3 class="ms-thumbnail-caption-title color-primary">Lorem ipsum dolor sit</h3>
                              <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p>
                    ...
                    <div class="col-sm-6 mb-2">
                      <h3 class="text-center">Light</h3>
                      <div class="ms-thumbnail-container">
                        <figure class="ms-thumbnail ms-thumbnail-light">
                          <img src="assets/img/demo/port22.jpg" alt="" class="img-fluid">
                          <figcaption class="ms-thumbnail-caption text-center">
                            <div class="ms-thumbnail-caption-content">
                              <h3 class="ms-thumbnail-caption-title color-royal">Caption Title</h3>
                              <p>Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
                              <a href="javascript:void(0)" class="btn-circle btn-circle-raised btn-circle-sm mr-1 btn-circle-danger">
                                <i class="zmdi zmdi-favorite"></i>
                              </a>
                              <a href="javascript:void(0)" class="btn-circle btn-circle-raised btn-circle-sm ml-1 mr-1 btn-circle-warning">
                                <i class="zmdi zmdi-star"></i>
                              </a>
                              <a href="javascript:void(0)" class="btn-circle btn-circle-raised btn-circle-sm ml-1 btn-circle-success">
                                <i class="zmdi zmdi-download"></i>
                              </a>
                            </div>
                          </figcaption>
                  ...
                  <div class="card card-info card-code">
                    ...
                    <div id="code3" class="card-collapse collapse" role="tabpanel" aria-labelledby="codeHead3">
                      <div class="card-code-block"> <pre><code class="language-markup line-numbers">&lt;h3 class=&quot;text-center&quot;&gt;Vertical&lt;/h3&gt;
&lt;div class=&quot;ms-thumbnail-container&quot;&gt;
    &lt;figure class=&quot;ms-thumbnail&quot;&gt;
        &lt;img src=&quot;&lt;%= assets %&gt;/img/demo/port11.jpg&quot; alt=&quot;&quot; class=&quot;img-fluid&quot;&gt;
        &lt;figcaption class=&quot;ms-thumbnail-caption text-center&quot;&gt;
