                ...
                <form class="form-horizontal">
                  <fieldset>
                    <div class="form-group row">
                      ...
                      <div class="col-md-9">
                        <input type="email" class="form-control" id="inputEmail-ñogin" placeholder="Email"> </div>
                    </div>
                    <div class="form-group row">
                      <label for="inputPassword-login" class="col-md-3 control-label">Password</label>
                      <div class="col-md-9">
                        <input type="password" class="form-control" id="inputPassword-login" placeholder="Password"> </div>
                    </div>
                  </fieldset>
                ...
                <form class="form-horizontal">
                  <fieldset>
                    ...
                    <div class="row form-group">
                      ...
                      <div class="col-md-9">
                        <input id="datePicker" type="text" class="form-control" placeholder="mm/dd/yy"> </div>
                    </div>
                    <div class="row mt-2">
