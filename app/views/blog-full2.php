          ...
          <div class="col-md-12">
            <article class="card card-primary wow zoomInRight animation-delay-5 mb-4">
              <div class="card-body card-body-big">
                <div class="row">
                  <div class="col-lg-12">
                    <img src="assets/img/demo/postG1.jpg" alt="" class="img-fluid center-block mb-4"> </div>
                  <div class="col-lg-12 mb-4">
                    ...
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dolor voluptatem in, ipsum. Ducimus culpa rerum in illo, enim quas voluptas, aliquid similique repudiandae amet car voluptatum suscipit, cum nulla hic possimus ad illum.</p>
                    <p>iste deserunt officia tempore laboriosam eos exercitationem excepturi? Porro animi mollitia molestias voluptatem recusandae, eius incidunt dolores, inventore esse, doloribus illum omnis ratione ducimus. Iure deleniti fuga voluptatibus
                      fugit voluptates ab.</p>
                  </div>
                </div>
                <div class="row">
                  <div class="col-lg-8">
            ...
            <article class="card card-primary wow zoomInRight animation-delay-5 mb-4">
              <div class="card-body card-body-big">
                <div class="row">
                  <div class="col-lg-12">
                    <img src="assets/img/demo/postG2.jpg" alt="" class="img-fluid center-block mb-4"> </div>
                  <div class="col-lg-12 mb-4">
                    <h3 class="no-mt">
                      <a href="javascript:void(0)">Earum delectus libero ipsa temporibus in minus</a>
                    </h3>
                ...
                <div class="row">
                  <div class="col-lg-8">
                    ...
                    <span class="ml-1 d-none d-sm-inline">
                      <i class="zmdi zmdi-time mr-05 color-info"></i>
                      <span class="color-medium-dark">January 27, 2016</span>
                    </span>
                  </div>
                  <div class="col-lg-4 text-right">
                    <a href="javascript:void(0)" class="btn btn-primary btn-raised btn-block animate-icon">Read More
            ...
            <article class="card card-primary wow zoomInRight animation-delay-5 mb-4">
              <div class="card-body card-body-big">
                <div class="row">
                  <div class="col-lg-12">
                    <img src="assets/img/demo/postG3.jpg" alt="" class="img-fluid center-block mb-4"> </div>
                  <div class="col-lg-12 mb-4">
                    <h3 class="no-mt">
                      <a href="javascript:void(0)">Earum delectus libero ipsa temporibus in minus</a>
                    </h3>
                ...
                <div class="row">
                  <div class="col-lg-8">
                    <img src="assets/img/demo/avatar50.jpg" alt="..." class="img-circle mr-1"> by
                    <a href="javascript:void(0)">Victoria</a> in
                    <a href="javascript:void(0)" class="ms-tag ms-tag-royal">Productivity</a>
                    <span class="ml-1 d-none d-sm-inline">
                      <i class="zmdi zmdi-time mr-05 color-info"></i>
                      <span class="color-medium-dark">Aufust 18, 2015</span>
                    </span>
                  </div>
                  <div class="col-lg-4 text-right">
                    <a href="javascript:void(0)" class="btn btn-primary btn-raised btn-block animate-icon">Read More
            ...
            <article class="card card-primary wow zoomInRight animation-delay-5 mb-4">
              <div class="card-body card-body-big">
                <div class="row">
                  <div class="col-lg-12">
                    <img src="assets/img/demo/postG4.jpg" alt="" class="img-fluid center-block mb-4"> </div>
                  <div class="col-lg-12 mb-4">
                    <h3 class="no-mt">
                      <a href="javascript:void(0)">Earum delectus libero ipsa temporibus in minus</a>
                    </h3>
            ...
            <article class="card card-primary wow zoomInRight animation-delay-5 mb-4">
              <div class="card-body card-body-big">
                <div class="row">
                  <div class="col-lg-12">
                    <img src="assets/img/demo/postG5.jpg" alt="" class="img-fluid center-block mb-4"> </div>
                  <div class="col-lg-12 mb-4">
                    <h3 class="no-mt">
                      <a href="javascript:void(0)">Earum delectus libero ipsa temporibus in minus</a>
                    </h3>
