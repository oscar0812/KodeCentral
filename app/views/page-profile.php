...
<html lang="en">
  ...
  <body>
    ...
    <div class="ms-site-container">
      ...
      <div class="ms-hero-page-override ms-hero-img-coffee ms-bg-fixed ms-hero-bg-primary">
        <div class="container">
          <div class="text-center mt-2">
            <img src="assets/img/demo/avatar1.jpg" alt="..." class="ms-avatar-hero animated zoomIn animation-delay-7">
            <h1 class="color-white mt-4 animated fadeInUp animation-delay-10">Ana Sanz</h1>
            <h3 class="color-medium no-mb animated fadeInUp animation-delay-10">@anasanz</h3>
          </div>
        </div>
      </div>
      <div class="container">
        <div class="card card-hero card-primary animated fadeInUp animation-delay-7">
          ...
          <div class="row">
            <div class="col-xl-4 col-12">
              <div class="card-body">
                <h2 class="color-primary no-mb">Personal Information</h2>
              </div>
              <table class="table table-no-border table-striped">
                <tr>
                  <th>
                    <i class="zmdi zmdi-account mr-1 color-royal"></i> User Name</th>
                  <td>anasanz</td>
                </tr>
                <tr>
                  <th>
                ...
                <tr>
                  <th>
                    <i class="zmdi zmdi-male-female mr-1 color-success"></i> Gender</th>
                  <td>Female</td>
                </tr>
                <tr>
                  <th>
              ...
              <div class="card-body">
                ...
                <div class="media mb-3">
                  <div class="media-left">
                    <a class="mr-3" href="#">
                      <img src="assets/img/demo/64blue.svg"> </a>
                  </div>
                ...
                <div class="media mb-3">
                  <div class="media-left">
                    <a class="mr-3" href="#">
                      <img src="assets/img/demo/64orange.svg"> </a>
                  </div>
                  <div class="media-body">
                    <h4 class="no-m">
                      <a href="#">Lorem ipsum dolor sit</a>
                ...
                <div class="media mb-3">
                  <div class="media-left">
                    <a class="mr-3" href="#">
                      <img src="assets/img/demo/64sky.svg"> </a>
                  </div>
                  <div class="media-body">
                    <h4 class="no-m">
                      <a href="#">Lorem ipsum dolor sit</a>
      ...
      <!-- container -->
      <div class="container">
        <h1 class="color-primary text-center mb-4">Recent Activity</h1>
        <div class="row">
          <div class="col-md-12">
