    ...
    <div class="ms-site-container">
      ...
      <div class="container">
        <div class="card wow slideInUp">
          ...
          <img src="assets/img/demo/team.jpg" alt="" class="img-fluid">
          <div class="card-body-big">
            ...
            <div class="card-body-big">
              ...
              <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-6">
                  <div class="card card-body overflow-hidden text-center wow zoomInUp animation-delay-2">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                  <div class="card card-body overflow-hidden text-center wow zoomInUp animation-delay-5">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                  <div class="card card-body overflow-hidden text-center wow zoomInUp animation-delay-4">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                  <div class="card card-body overflow-hidden text-center wow zoomInUp animation-delay-3">
          ...
          <div class="js-player" data-plyr-provider="vimeo" data-plyr-embed-id="30555090"></div>
        </div>
      </div>
      <!-- container -->
