  ...
  <body>
    ...
    <div class="ms-site-container">
      ...
      <div class="ms-hero-page ms-hero-img-city2 ms-hero-bg-info">
        <div class="container">
          <div class="text-center">
            <h1 class="no-m ms-site-title color-white center-block ms-site-title-lg mt-2 animated zoomInDown animation-delay-5">Classified Ads</span>
            </h1>
                ...
                <div class="col-lg-6">
                  <div class="form-group label-floating input-group ">
                    <label class="control-label color-white" for="ms-class-search">
                      <i class="zmdi zmdi-local-offer mr-1"></i> Search something...</label>
          ...
          <div class="col-lg-9">
            <div class="card animated slideInUp animation-delay-8 mb-6">
              <div class="card-body card-body-big">
                <h3 class="right-line no-mt">Find Classified Ads</h3>
                <div class="row masonry-container">
                  <div class="col-md-4 col-sm-6 masonry-item">
                    ...
                    <ul class="list-unstyled color-dark text-small">
                      <li>
                        <a href="javascript:void(0)">Car Parts &amp; Accessories</a>
                      </li>
                      <li>
                        <a href="javascript:void(0)">Campervans &amp; Caravans</a>
                      </li>
                      <li>
                        <a href="javascript:void(0)">Vans, Trucks &amp; Plant</a>
                      </li>
                      <li>
                        <a href="javascript:void(0)">Motorbikes &amp; Scooters</a>
                      </li>
                      <li>
                        <a href="javascript:void(0)">Motorbike Parts &amp; Accessories</a>
                      </li>
                      <li>
                        <a href="javascript:void(0)">Wanted</a>
                      </li>
                    </ul>
                  </div>
                  <div class="col-md-4 col-sm-6 masonry-item">
                    ...
                    <ul class="list-unstyled color-dark text-small">
                      <li>
                        <a href="javascript:void(0)">Building, Home &amp; Removals</a>
                      </li>
                      <li>
                      ...
                      <li>
                        <a href="javascript:void(0)">Property &amp; Shipping</a>
                      </li>
                      <li>
                        <a href="javascript:void(0)">Tax, Money &amp; Visas</a>
                      </li>
                      <li>
                        <a href="javascript:void(0)">Telecoms &amp; Computers</a>
                      </li>
                      <li>
                        <a href="javascript:void(0)">Travel Services &amp; Tours</a>
                      </li>
                    </ul>
                  </div>
                  <div class="col-md-4 col-sm-6 masonry-item">
                    ...
                    <ul class="list-unstyled color-dark text-small">
                      <li>
                        <a href="javascript:void(0)">Audio &amp; Stereo</a>
                      </li>
                      <li>
                        <a href="javascript:void(0)">Baby &amp; Kids Stuff</a>
                      </li>
                      <li>
                        <a href="javascript:void(0)">CDs, DVDs, Games &amp; Books</a>
                      </li>
                      <li>
                        <a href="javascript:void(0)">Clothes, Footwear &amp; Accessories</a>
                      </li>
                      <li>
                        <a href="javascript:void(0)">Computers &amp; Software</a>
                      </li>
                      <li>
                        <a href="javascript:void(0)">Home &amp; Garden</a>
                      </li>
                      <li>
                        <a href="javascript:void(0)">Music &amp; Instruments</a>
                      </li>
                      <li>
                        <a href="javascript:void(0)">Office Furniture &amp; Equipment</a>
                      </li>
                      <li>
                        <a href="javascript:void(0)">Phones, Mobile Phones &amp; Telecoms</a>
                      </li>
                      <li>
                        <a href="javascript:void(0)">Sports, Leisure &amp; Travel</a>
                      </li>
                      <li>
                        <a href="javascript:void(0)">Tickets</a>
                      </li>
                      <li>
                        <a href="javascript:void(0)">TV, DVD &amp; Cameras</a>
                      </li>
                      <li>
                      ...
                      <li>
                        <a href="javascript:void(0)">Miscellaneous Goods</a>
                      </li>
                      <li>
                        <a href="javascript:void(0)">Stuff Wanted</a>
                      </li>
                      <li>
                        <a href="javascript:void(0)">Swap Shop</a>
                      </li>
                    </ul>
                  </div>
                  <div class="col-md-4 col-sm-6 masonry-item">
                    ...
                    <ul class="list-unstyled color-dark text-small">
                      <li>
                        <a href="javascript:void(0)">House for Rent</a>
                      </li>
                      <li>
                        <a href="javascript:void(0)">House for Sale</a>
                      </li>
                      <li>
                        <a href="javascript:void(0)">Apartments For Sale</a>
                      </li>
                      <li>
                        <a href="javascript:void(0)">Apartments for Rent</a>
                      </li>
                      <li>
                        <a href="javascript:void(0)">Farms-Ranches</a>
                      </li>
                      <li>
                      ...
                      <li>
                        <a href="javascript:void(0)">Commercial Building</a>
                      </li>
                    </ul>
                  </div>
                  <div class="col-md-4 col-sm-6 masonry-item">
                    ...
                    <ul class="list-unstyled color-dark text-small">
                      <li>
                        <a href="javascript:void(0)">Automotive Classes</a>
                      </li>
                      <li>
                        <a href="javascript:void(0)">Computer Multimedia Classes</a>
                      </li>
                      <li>
                        <a href="javascript:void(0)">Sports Classes</a>
                      </li>
                      <li>
                        <a href="javascript:void(0)">Home Improvement Classes</a>
                      </li>
                      <li>
                        <a href="javascript:void(0)">Language Classes</a>
                      </li>
                      <li>
                        <a href="javascript:void(0)">Music Classes</a>
                      </li>
                      <li>
                        <a href="javascript:void(0)">Personal Fitness</a>
                      </li>
                      <li>
                        <a href="javascript:void(0)">Other Classes</a>
                      </li>
                    </ul>
                  </div>
                  <div class="col-md-4 col-sm-6 masonry-item">
                    ...
                    <ul class="list-unstyled color-dark text-small">
                      <li>
                        <a href="javascript:void(0)">Full Time Jobs</a>
                      </li>
                      <li>
                        <a href="javascript:void(0)">Internet Jobs</a>
                      </li>
                      <li>
                        <a href="javascript:void(0)">Learn &amp; Earn jobs</a>
                      </li>
                      <li>
                        <a href="javascript:void(0)">Manual Labor Jobs</a>
                      </li>
                      <li>
                        <a href="javascript:void(0)">Other Jobs</a>
                      </li>
                      <li>
                        <a href="javascript:void(0)">OwnBusiness</a>
                      </li>
                    </ul>
                  </div>
                  <div class="col-md-4 col-sm-6 masonry-item">
                    ...
                    <ul class="list-unstyled color-dark text-small">
                      <li>
                        <a href="javascript:void(0)">Pets for Sale</a>
                      </li>
                      <li>
                        <a href="javascript:void(0)">Petsitters &amp; Dogwalkers</a>
                      </li>
                      <li>
                        <a href="javascript:void(0)">Equipment &amp; Accessories</a>
                      </li>
                      <li>
                        <a href="javascript:void(0)">Missing, Lost &amp; Found</a>
                      </li>
                    </ul>
                  </div>
                  <div class="col-md-4 col-sm-6 masonry-item">
                    ...
                    <ul class="list-unstyled color-dark text-small">
                      ...
                      <li>
                        <a href="javascript:void(0)">Car Pool - Bike Ride</a>
                      </li>
                      <li>
                        <a href="javascript:void(0)">Charity - Donate - NGO</a>
                      </li>
                      <li>
                        <a href="javascript:void(0)">Lost - Found</a>
                      </li>
                      <li>
                        <a href="javascript:void(0)">Tender Notices</a>
                      </li>
                    </ul>
                  </div>
                </div>
          ...
          <div class="col-lg-3">
            <div class="card card-warning animated zoomInUp animation-delay-7">
              <div class="card-header">
                <h4 class="card-title">
                  <i class="zmdi zmdi-star"></i> Popular Categories</h4>
              </div>
              <div class="list-group">
                <a href="javascript:void(0)" class="list-group-item list-group-item-action withripple">
                  <i class=" color-info zmdi zmdi-collection-image"></i> Entertainment
                  <span class="ml-auto badge-pill badge-pill-info">1334</span>
                </a>
                <a href="javascript:void(0)" class="list-group-item list-group-item-action withripple">
                  <i class=" color-danger zmdi zmdi-case-check"></i> Full Time Jobs
                  <span class="ml-auto badge-pill badge-pill-danger">790</span>
                </a>
                <a href="javascript:void(0)" class="list-group-item list-group-item-action withripple">
                  <i class=" color-royal zmdi zmdi-home"></i>House for Rent
                  <span class="ml-auto badge-pill badge-pill-royal">657</span>
                </a>
                <a href="javascript:void(0)" class="list-group-item list-group-item-action withripple">
                  <i class=" color-success zmdi zmdi-ticket-star"></i>Tickets
                  <span class="ml-auto badge-pill badge-pill-success">452</span>
                </a>
              </div>
            </div>
            <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">
                  <i class="zmdi zmdi-money"></i> Sell Something</h3>
              </div>
              <div class="card-body overflow-hidden text-center">
                <span class="ms-icon ms-icon-circle ms-icon-xlg color-info">
                  <i class="fa fa-diamond"></i>
                </span>
                <p>You can sell your own products. Start selling now and make money with what I do not use.</p>
                <a href="javascript:void(0)" class="btn btn-raised btn-info">Start Selling</a>
              </div>
            </div>
            <div class="card card-danger timeline-center-item right wow fadeInUp">
              <header class="card-header">
                <h3 class="card-title">
                  <i class="zmdi zmdi-play-circle-outline"></i> Ads</h3>
              </header>
      ...
      <div class="container mt-6">
        <div class="row">
          <div class="col-lg-6">
            <div class="card wow fadeInUp animation-delay-4">
              <div class="card-body card-body-big">
                <h3 class="color-primary no-mt">
                  <span class="ms-icon ms-icon-circle">
                    <i class="zmdi zmdi-pin"></i>
                  </span> Popular Locations</h3>
                <div class="row">
                  <div class="col-sm-6">
                    <ul class="list-unstyled color-dark text-small">
                      <li>
                        <a href="javascript:void(0)">Atlanta</a>
                      </li>
                      <li>
                        <a href="javascript:void(0)">Wichita</a>
                      </li>
                      <li>
                        <a href="javascript:void(0)">Anchorage</a>
                      </li>
                      <li>
                      ...
                      <li>
                        <a href="javascript:void(0)">Santa Ana/Anaheim</a>
                      </li>
                      <li>
                  ...
                  <div class="col-sm-6">
                    <ul class="list-unstyled color-dark text-small">
                      <li>
                        <a href="javascript:void(0)">Virginia Beach</a>
                      </li>
                      <li>
                      ...
                      <li>
                        <a href="javascript:void(0)">Salt Lake City</a>
                      </li>
                      <li>
                ...
                <div class="row">
                  <div class="col-sm-4">
                    <ul class="list-unstyled color-dark text-small">
                      ...
                      <li>
                        <a href="javascript:void(0)">household</a>
                      </li>
                      <li>
                      ...
                      <li>
                        <a href="javascript:void(0)">sporting</a>
                      </li>
                      <li>
                        <a href="javascript:void(0)">tickets</a>
                      </li>
                  ...
                  <div class="col-sm-4">
                    <ul class="list-unstyled color-dark text-small">
                      ...
                      <li>
                        <a href="javascript:void(0)">cell phones</a>
                      </li>
                      <li>
                        <a href="javascript:void(0)">clothes+acc</a>
                      </li>
                      <li>
                      ...
                      <li>
                        <a href="javascript:void(0)">farm+garden</a>
                      </li>
                      <li>
                        <a href="javascript:void(0)">garage sale</a>
                      </li>
                    </ul>
                  </div>
                  <div class="col-sm-4">
                    <ul class="list-unstyled color-dark text-small">
                      <li>
                        <a href="javascript:void(0)">heavy equip</a>
                      </li>
                      <li>
                        <a href="javascript:void(0)">motorcycles</a>
                      </li>
                      <li>
                        <a href="javascript:void(0)">music instr</a>
                      </li>
                      <li>
                      ...
                      <li>
                        <a href="javascript:void(0)">arts+crafts</a>
                      </li>
                      <li>
