                  ...
                  <ul class="panel-group ms-collapse-nav" id="components-nav" role="tablist" aria-multiselectable="true">
                    ...
                    <li class="card" role="tab" id="e5">
                      ...
                      <ul id="c5" class="panel-collapse collapse show" role="tabpanel" aria-labelledby="e5" data-parent="#components-nav">
                        <li>
                          <a class="withripple active" href="component-cards.php">
                            <i class="zmdi zmdi-card-membership"></i> Cards</a>
                        </li>
                        <li>
                          <a class="withripple" href="component-composite-cards.php">
              ...
              <div class="ms-paper-content">
                ...
                <section class="ms-component-section">
                  ...
                  <div class="row">
                    <div class="col-md-4">
                      <div class="card">
                        <div class="card-body"> Lorem ipsum dolor sit amet, consectetur adipisicing elit. Suscipit facilis, explicabo sunt distinctio vitae quo? Dolores neque cumque, perferendis velit. </div>
                      </div>
                    </div>
                    <div class="col-md-4">
                      <div class="card">
                        ...
                        <div class="card-body"> Lorem ipsum dolor sit amet, consectetur adipisicing elit. Libero atque voluptatem iure officiis magnam fugit. </div>
                      </div>
                    </div>
                    <div class="col-md-4">
                      <div class="card">
