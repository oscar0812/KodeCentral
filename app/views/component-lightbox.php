                  ...
                  <ul class="panel-group ms-collapse-nav" id="components-nav" role="tablist" aria-multiselectable="true">
                    ...
                    <li class="card" role="tab" id="e5">
                      ...
                      <ul id="c5" class="panel-collapse collapse show" role="tabpanel" aria-labelledby="e5" data-parent="#components-nav">
                        ...
                        <li>
                          <a class="withripple active" href="component-lightbox.php">
            ...
            <div class="col-lg-9 ms-paper-content-container">
              <div class="ms-paper-content">
                ...
                <div class="alert alert-light alert-info">
                  ...
                  <i class="fa fa-info"></i> Example of use in
                  <a href="portfolio-gallery.php">Image Gallery</a>. </div>
                <section class="ms-component-section">
                  <h2 class="section-title no-margin-top">Single Lightbox Image</h2>
                  <div class="row">
                    <div class="col-lg-6">
                      <a href="assets/img/demo/port2.jpg" data-lightbox="port-1" data-title="My caption" class="img-thumbnail withripple">
                        <div class="thumbnail-container">
                          <img src="assets/img/demo/port2.jpg" alt="..." class="img-fluid"> </div>
                      </a>
                    </div>
                    <div class="col-lg-6">
                      <a href="assets/img/demo/port3.jpg" data-lightbox="port-2" data-title="My caption" class="img-thumbnail withripple color-light">
                        <div class="thumbnail-container">
                  ...
                  <div class="card card-info card-code">
                    ...
                    <div id="code1" class="card-collapse collapse" role="tabpanel" aria-labelledby="codeHead1">
                      <div class="card-code-block"> <pre><code class="language-markup line-numbers">&lt;a href=&quot;img/image-1.jpg&quot; data-lightbox=&quot;image-1&quot; data-title=&quot;My caption&quot;&gt;Image #1&lt;/a&gt;
</code></pre> </div>
                    </div>
                  </div>
                  <!-- card-code -->
                ...
                <section class="ms-component-section">
                  <h2 class="section-title">Lightbox Gallery</h2>
                  <div class="row">
                    <div class="col-md-4">
                      <a href="assets/img/demo/port4.jpg" data-lightbox="gallery-example" data-title="My caption" class="img-thumbnail withripple color-danger">
                        <div class="thumbnail-container">
                          <img src="assets/img/demo/port4.jpg" alt="..." class="img-fluid"> </div>
                      </a>
                    </div>
                    <div class="col-md-4">
                      <a href="assets/img/demo/port5.jpg" data-lightbox="gallery-example" data-title="My caption" class="img-thumbnail withripple color-warning">
                        <div class="thumbnail-container">
                          <img src="assets/img/demo/port5.jpg" alt="..." class="img-fluid"> </div>
                      </a>
                    </div>
                    <div class="col-md-4">
                      <a href="assets/img/demo/port6.jpg" data-lightbox="gallery-example" data-title="My caption" class="img-thumbnail withripple color-royal">
                        <div class="thumbnail-container">
                          <img src="assets/img/demo/port6.jpg" alt="..." class="img-fluid"> </div>
                      </a>
                    </div>
                    <div class="col-md-4">
                      <a href="assets/img/demo/port1.jpg" data-lightbox="gallery-example" data-title="My caption" class="img-thumbnail withripple color-info">
                        <div class="thumbnail-container">
                          <img src="assets/img/demo/port1.jpg" alt="..." class="img-fluid"> </div>
                      </a>
                    </div>
                    <div class="col-md-4">
                      <a href="assets/img/demo/port7.jpg" data-lightbox="gallery-example" data-title="My caption" class="img-thumbnail withripple color-success">
                        <div class="thumbnail-container">
                          <img src="assets/img/demo/port7.jpg" alt="..." class="img-fluid"> </div>
                      </a>
                    </div>
                    <div class="col-md-4">
                      <a href="assets/img/demo/port8.jpg" data-lightbox="gallery-example" data-title="My caption" class="img-thumbnail withripple color-dark">
                        <div class="thumbnail-container">
                  ...
                  <div class="card card-info card-code">
                    ...
                    <div id="code2" class="card-collapse collapse" role="tabpanel" aria-labelledby="codeHead2">
                      <div class="card-code-block"> <pre><code class="language-markup line-numbers">&lt;a href=&quot;img/image-2.jpg&quot; data-lightbox=&quot;gallery-name&quot;&gt;Image #2&lt;/a&gt;
&lt;a href=&quot;img/image-3.jpg&quot; data-lightbox=&quot;gallery-name&quot;&gt;Image #3&lt;/a&gt;
&lt;a href=&quot;img/image-4.jpg&quot; data-lightbox=&quot;gallery-name&quot;&gt;Image #4&lt;/a&gt;
</code></pre> </div>
                    </div>
                  </div>
                  <!-- card-code -->
