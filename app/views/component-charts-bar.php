                ...
                <div class="panel-menu collapse" id="collapseMenu">
                  <ul class="panel-group ms-collapse-nav" id="components-nav" role="tablist" aria-multiselectable="true">
                    ...
                    <li class="card" role="tab" id="e7">
                      <a role="button" data-toggle="collapse" href="#c7" aria-expanded="true" aria-controls="c7" class="withripple">
                        <i class="fa fa-area-chart"></i> Charts</a>
                      <ul id="c7" class="panel-collapse collapse show" role="tabpanel" aria-labelledby="e7" data-parent="#components-nav">
                        <li>
                          <a class="withripple" href="component-charts-circle.php">
                            <i class<i class="zmdi zmdi-chart-donut"></i> Circle Charts</a>
                        </li>
                        <li>
                          <a class="withripple active" href="component-charts-bar.php">
                            <i class="fa fa-bar-chart"></i> Bars Charts</a>
                        </li>
                        <li>
                          <a class="withripple" href="component-charts-line.php">
            ...
            <div class="col-lg-9 ms-paper-content-container">
              <div class="ms-paper-content">
                ...
                <section class="ms-component-section">
                  <h2 class="section-title no-margin-top">Basic Chart</h2>
                  ...
                  <div class="card card-success">
                    ...
                    <div class="card-body">
                      <h3 class="color-success text-center">Lorem ipsum dolor sit</h3>
                      <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Placeat delectus eaque nostrum perferendis, dignissimos obcaecati aspernatur nihil a nulla fugiat adipisicing elit facilis consequuntur maiores, soluta labore ipsam eos necessitatibus
                        totam! Ipsam.</p>
                      <p>Rerum reiciendis soluta pariatur vitae, exercitationem dolorem nulla. Omnis blanditiis deleniti aliquid nemo odit quod ex laudantium itaque sed? Molestias tempore laborum, at quasi magnam repudiandae incidunt sapiente minus numquam.</p>
                    </div>
                  </div>
                </section>
                <div class="alert alert-royal alert-light">
                  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                    <i class="zmdi zmdi-close"></i>
                  </button>
                  <strong>Info:</strong> Material Style use the
                  <a href="http://www.chartjs.org/">chart.js</a> library to create charts. Read the documentation to adapt the graphics to your project. </div>
              </div>
              <!-- ms-paper-content -->
            </div>
            <!-- col-lg-9 -->
