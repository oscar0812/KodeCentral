...
<html lang="en">
  ...
  <body>
    ...
    <div class="ms-site-container">
      ...
      <header class="ms-hero-page ms-hero-video ms-hero-img-room ms-hero-bg-dark color-white intro-hero-full">
        <div class="intro-hero-full-content">
          <div class="container text-center">
            <span class="ms-logo ms-logo-lg ms-logo-white center-block mb-2 mt-2 animated zoomInDown animation-delay-7">M</span>
            <h2 class="no-m ms-site-title color-white center-block ms-site-title-lg mt-2 animated zoomInDown animation-delay-7">Material
              <span>Style</span>
            </h2>
            <h1 class="animated fadeInUp animation-delay-12">Now is your time to
              <span class="typed-class typed-block color-primary">be creative</span>
            </h1>
          </div>
        </div>
      </header>
      ...
      <div class="wrap ms-hero-img-road ms-hero-bg-royal ms-bg-fixe mt-6">
        <div class="container">
          ...
          <div class="row no-gutters">
            ...
            <div class="col-lg-4">
              <div class="price-table price-table-info prominent wow zoomInDown animation-delay-2">
                <header class="price-table-header">
      ...
      <div class="container">
        <div class="card wow fadeInUp mt-6">
          <div class="card-body card-body-big">
        ...
        <div class="card card-primary-inverse mt-6 wow fadeInUp">
          <div class="card-body card-body-big">
