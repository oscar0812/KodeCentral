...
<html lang="en">
  ...
  <body>
    ...
    <div class="ms-site-container">
      ...
      <header class="ms-hero-page-override ms-hero-img-meeting ms-hero-bg-dark ms-bg-fixed">
        <div class="container">
          <div class="text-center">
            <span class="ms-logo ms-logo-lg ms-logo-white center-block mb-2 mt-2 animated zoomInDown animation-delay-5">M</span>
            <h1 class="no-m ms-site-title color-white center-block ms-site-title-lg mt-2 animated zoomInDown animation-delay-5">Material Style</span>
            </h1>
            ...
            <div class="col-xl-3 col-lg-3 col-md-6">
              <div class="card card-info animated zoomInUp animation-delay-5">
                ...
                <div class="card-body pt-4 text-center">
                  ...
                  <p>Eaque repellendus nemo deserunt qui sequi in assumenda caecati.</p>
      ...
      <div class="wrap bg-info color-dark">
        <div class="container">
          <h2 class="text-center color-white mb-4">Our Latest Works</h2>
          ...
          <div class="owl-carousel owl-theme">
            ...
            <div class="card card-warning-inverse animation-delay-8">
              <div class="withripple zoom-img">
                <a href="javascript:void()">
              ...
              <div class="card-body">
                ...
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Autem, repellat, vitae porro ex expedita cumque nulla.</p>
                <p class="text-right">
                  <a href="javascript:void()" class="btn btn-white color-warning btn-raised text-right" role="button">
                    <i class="zmdi zmdi-collection-image-o"></i> View More</a>
                </p>
              </div>
            </div>
          ...
          <div class="text-center mt-4">
            ...
            <a href="javascript:void(0)" class="btn btn-white btn-xlg btn-raised color-info">
              <i class="zmdi zmdi-desktop-windows"></i> View Portfolio</a>
          </div>
        </div>
        <!-- container -->
      </div>
    ...
    <script src="assets/js/home-generic-5.js"></script>
  </body>
</html>