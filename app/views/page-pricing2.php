    ...
    <div class="ms-site-container">
      ...
      <div class="wrap ms-hero-img-coffee ms-hero-bg-warning ms-bg-fixed">
        <div class="container color-dark">
          <div class="row no-gutters card-hero no-shadow">
              ...
              <div class="price-table price-table-info wow zoomInUp animation-delay-2">
                ...
                <div class="price-table-body">
                  <ul class="price-table-list">
                    ...
                    <li>
                      <i class="zmdi zmdi-globe"></i> Voluptate ex quam autem oue.</li>
                    <li>
                      <i class="zmdi zmdi-settings"></i> Disimos velit reic cumque.</li>
                    <li>
                      <i class="zmdi zmdi-cloud"></i> Nihil copti soluta vitae non.</li>
                    <li>
                      <i class="zmdi zmdi-star"></i> Atque molest blanditis ratione.</li>
                  </ul>
                  <div class="text-center">
            ...
            <div class="col-xl-3 col-md-6">
              <div class="price-table price-table-success prominent-lg wow zoomInDown animation-delay-2">
                <header class="price-table-header">
            ...
            <div class="col-xl-3 col-md-6">
              <div class="price-table price-table-royal wow zoomInUp animation-delay-2">
                <header class="price-table-header">
                  <span class="price-table-category">Custom</span>
                  <h3>
                    <sup>$</sup>199.99
                    <sub>/mo.</sub>
                  </h3>
          ...
          <div class="text-center wow fadeInUp animation-delay-7">
            ...
            <a href="javascript:void(0)" class="btn btn-white btn-raised color-info">
      ...
      <div class="wrap bg-info color-dark">
        <div class="container">
          <div class="text-center wow fadeInUp">
            <h1 class="color-white mb-4 animated fadeInDown animation-delay-4">Pricing Mega Table</h1>
            <p class="lead lead-xl mw-800 center-block color-light mb-6 animated fadeInDown animation-delay-4"> We are at the
              <span class="color-white">forefront of innovation</span>.
              <br> Discover with us the possibilities of
              <span class="color-white animation-delay-10">your next project</span>. </p>
          </div>
