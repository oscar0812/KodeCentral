                  ...
                  <ul class="panel-group ms-collapse-nav" id="components-nav" role="tablist" aria-multiselectable="true">
                    ...
                    <li class="card" role="tab" id="e4">
                      ...
                      <ul id="c4" class="panel-collapse collapse show" role="tabpanel" aria-labelledby="e4" data-parent="#components-nav">
                        ...
                        <li>
                          <a class="withripple active" href="component-lists.php">
                            <i class="zmdi zmdi-view-list"></i> Lists</a>
                        </li>
                        <li>
                          <a class="withripple" href="component-thumbnails.php">
            ...
            <div class="col-lg-9 ms-paper-content-container">
              <div class="ms-paper-content">
                ...
                <section class="ms-component-section">
                  <h2 class="section-title no-margin-top">Secction Header</h2>
                  <div class="row">
                    <div class="col-md-6">
                      <h3>Basic list</h3>
                      <ul class="list-group">
                        <li class="list-group-item">Cras justo odio
                          <span class="ml-auto badge-pill bg-primary">5</span>
                        </li>
                        <li class="list-group-item">
                          <i class="zmdi zmdi-favorite-outline"></i> Dapibus ac facilisis in
                          <span class="ml-auto badge-pill">14</span>
                        </li>
                        <li class="list-group-item">
                          <i class="zmdi zmdi-star"></i>Morbi leo risus</li>
                        <li class="list-group-item">
                          <i class="zmdi zmdi-email"></i>Porta ac consectetur ac
                          <span class="ml-auto badge-pill bg-royal">7</span>
                        </li>
                        <li class="list-group-item">
                          <i class="zmdi zmdi-fire"></i>Vestibulum at eros</li>
                      </ul>
                    </div>
                    <div class="col-md-6">
                      <h3>With Links</h3>
                      <div class="list-group">
                        <a href="javascript:void(0)" class="list-group-item list-group-item-action withripple">
                          <i class="color-primary zmdi zmdi-favorite-outline"></i>Cras justo odio
                          <span class="ml-auto badge-pill bg-danger">5</span>
                        </a>
                        <a href="javascript:void(0)" class="list-group-item list-group-item-action withripple">
                          <i class="color-primary zmdi zmdi-hotel"></i>Dapibus ac facilisis in
                          <span class="ml-auto badge-pill">14</span>
                        </a>
                        <a href="javascript:void(0)" class="list-group-item list-group-item-action withripple">
                          <i class="color-primary zmdi zmdi-label"></i>Morbi leo risus</a>
                        <a href="javascript:void(0)" class="list-group-item list-group-item-action withripple">
                          <i class="color-primary zmdi zmdi-library"></i>Porta ac consectetur ac
                          <span class="ml-auto badge-pill bg-success">15</span>
                        </a>
                        <a href="javascript:void(0)" class="list-group-item list-group-item-action withripple">
                          <i class="color-primary zmdi zmdi-nature"></i>Vestibulum at eros</a>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-6">
                      <h3>Inside a card &amp; Colors</h3>
                      <div class="card">
                        <ul class="list-group">
                          <li class="list-group-item">
                            <i class="color-primary zmdi zmdi-pin"></i>Cras justo odio</li>
                          <li class="list-group-item">
                            <i class="color-success zmdi zmdi-subway"></i> Dapibus ac facilisis in
                            <span class="ml-auto badge-pill">14</span>
                          </li>
                          <li class="list-group-item">
                            <i class="color-info zmdi zmdi-eye"></i>Morbi leo risus</li>
                          <li class="list-group-item">
                            <i class="color-danger zmdi zmdi-dns"></i>Porta ac consectetur ac</li>
                          <li class="list-group-item">
                            <i class="color-warning zmdi zmdi-coffee"></i>Vestibulum at eros</li>
                        </ul>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <h3>Links Inside a Card</h3>
                      <div class="card">
                        <div class="list-group">
                          <a href="javascript:void(0)" class="list-group-item list-group-item-action withripple active">
                            <i class="zmdi zmdi-favorite"></i>Cras justo odio</a>
                          <a href="javascript:void(0)" class="list-group-item list-group-item-action withripple">
                            <i class="zmdi zmdi-cocktail"></i> Dapibus ac facilisis in
                            <span class="ml-auto badge-pill">14</span>
                          </a>
                          <a href="javascript:void(0)" class="list-group-item list-group-item-action withripple">
                            <i class="zmdi zmdi-cast"></i>Morbi leo risus</a>
                          <a href="javascript:void(0)" class="list-group-item list-group-item-action withripple">
                            <i class="zmdi zmdi-city"></i>Porta ac consectetur ac</a>
                          <a href="javascript:void(0)" class="list-group-item list-group-item-action withripple">
                            <i class="zmdi zmdi-chart"></i>Vestibulum at eros</a>
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class="card card-info card-code">
                    ...
                    <div id="code1" class="card-collapse collapse" role="tabpanel" aria-labelledby="codeHead1">
                      <div class="card-code-block"> <pre><code class="language-markup line-numbers">&lt;ul class=&quot;list-group&quot;&gt;
    &lt;li class=&quot;list-group-item&quot;&gt;&lt;span class=&quot;ml-auto badge-pill bg-primary&quot;&gt;5&lt;/span&gt;Cras justo odio&lt;/li&gt;
    &lt;li class=&quot;list-group-item&quot;&gt;&lt;i class=&quot;zmdi zmdi-favorite-outline&quot;&gt;&lt;/i&gt;&lt;span class=&quot;ml-auto badge-pill&quot;&gt;14&lt;/span&gt; Dapibus ac facilisis in&lt;/li&gt;
    &lt;li class=&quot;list-group-item&quot;&gt;&lt;i class=&quot;zmdi zmdi-star&quot;&gt;&lt;/i&gt;Morbi leo risus&lt;/li&gt;
    &lt;li class=&quot;list-group-item&quot;&gt;&lt;i class=&quot;zmdi zmdi-email&quot;&gt;&lt;/i&gt;&lt;span class=&quot;ml-auto badge-pill bg-royal&quot;&gt;7&lt;/span&gt;Porta ac consectetur ac&lt;/li&gt;
    &lt;li class=&quot;list-group-item&quot;&gt;&lt;i class=&quot;zmdi zmdi-fire&quot;&gt;&lt;/i&gt;Vestibulum at eros&lt;/li&gt;
&lt;/ul&gt;

&lt;h3&gt;With Links&lt;/h3&gt;
&lt;div class=&quot;list-group&quot;&gt;
    &lt;a href=&quot;javascript:void(0)&quot; class=&quot;list-group-item list-group-item-action withripple&quot;&gt;...&lt;/a&gt;
    &lt;a href=&quot;javascript:void(0)&quot; class=&quot;list-group-item list-group-item-action withripple&quot;&gt;...&lt;/a&gt;
    &lt;a href=&quot;javascript:void(0)&quot; class=&quot;list-group-item list-group-item-action withripple&quot;&gt;...&lt;/a&gt;
    &lt;a href=&quot;javascript:void(0)&quot; class=&quot;list-group-item list-group-item-action withripple&quot;&gt;...&lt;/a&gt;
    &lt;a href=&quot;javascript:void(0)&quot; class=&quot;list-group-item list-group-item-action withripple&quot;&gt;...&lt;/a&gt;
