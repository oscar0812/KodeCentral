          ...
          <div class="col-md-12">
            <div class="card animated materialUp animation-delay-5" ">
                <div class="card-body card-body-big ">
                    <h1 class="no-mt ">Repellat sequi id reiciendis ipsum placeat accusantium debitis reprehenderit quia in atque</h1>
                    <div class="mb-4 ">
                    ...
                    <img src="assets/img/demo/postG3.jpg " alt=" " class="img-fluid mb-4
              ">
            ...
            <div class="col-lg-4 ms-footer-col ">
                <div class="ms-footbar-block ">
                    ...
                    <ul class="list-unstyled ms-icon-list three_cols ">
                        ...
                        <li><a href="page-blog.php "><i class="zmdi zmdi-edit "></i> Blog</a></li>
                        <li><a href="page-blog.php "><i class="zmdi zmdi-image-o "></i> Portafolio</a></li>
                        <li><a href="portfolio-filters_sidebar.php "><i class="zmdi zmdi-case "></i> Works</a></li>
                        <li><a href="page-timeline_left2.php "><i class="zmdi zmdi-time "></i> Timeline</a></li>
                        <li><a href="page-pricing.php "><i class="zmdi zmdi-money "></i> Pricing</a></li>
                        <li><a href="page-about.php "><i class="zmdi zmdi-favorite-outline "></i> About Us</a></li>
                        <li><a href="page-team2.php "><i class="zmdi zmdi-accounts "></i> Our Team</a></li>
                        <li><a href="page-services.php "><i class="zmdi zmdi-face "></i> Services</a></li>
                        <li><a href="page-faq2.php "><i class="zmdi zmdi-help "></i> FAQ</a></li>
                        <li><a href="page-login2.php "><i class="zmdi zmdi-lock "></i> Login</a></li>
                        <li><a href="page-contact.php "><i class="zmdi zmdi-email "></i> Contact</a></li>
                    </ul>
                </div>
                <div class="ms-footbar-block ">
    ...
    <div class="sb-slidebar-container ">
        ...
        <ul class="ms-slidebar-menu " id="slidebar-menu " role="tablist " aria-multiselectable="true ">
            <li class="card " role="tab " id="sch1 ">
                ...
                <ul id="sc1 " class="card-collapse collapse " role="tabpanel " aria-labelledby="sch1 " data-parent="#slidebar-menu ">
                    ...
                    <li><a href="home-generic-2.php ">Home Black Slider</a></li>
                    <li><a href="home-landing.php ">Home Landing Intro</a></li>
                    <li><a href="home-landing3.php ">Home Landing Video</a></li>
                    <li><a href="home-shop.php ">Home Shop 1</a></li>
                </ul>
            </li>
            <li class="card " role="tab " id="sch2 ">
                ...
                <ul id="sc2 " class="card-collapse collapse " role="tabpanel " aria-labelledby="sch2 " data-parent="#slidebar-menu ">
                    ...
                    <li><a href="page-team.php ">Our Team</a></li>
                    <li><a href="page-product.php ">Products</a></li>
                    <li><a href="page-services.php ">Services</a></li>
                    <li><a href="page-faq.php ">FAQ</a></li>
                    <li><a href="page-timeline_left.php ">Timeline</a></li>
                    <li><a href="page-contact.php ">Contact Option</a></li>
                    <li><a href="page-login.php ">Login</a></li>
                    <li><a href="page-pricing.php ">Pricing</a></li>
                    <li><a href="page-coming.php ">Coming Soon</a></li>
                </ul>
            </li>
            <li class="card " role="tab " id="sch4 ">
                ...
                <ul id="sc4 " class="card-collapse collapse " role="tabpanel " aria-labelledby="sch4 " data-parent="#slidebar-menu ">
                    <li><a href="blog-sidebar.php ">Blog Sidebar 1</a></li>
                    <li><a href="blog-sidebar2.php ">Blog Sidebar 2</a></li>
                    <li><a href="blog-masonry.php ">Blog Masonry 1</a></li>
                    <li><a href="blog-masonry2.php ">Blog Masonry 2</a></li>
                    <li><a href="blog-full.php ">Blog Full Page 1</a></li>
                    <li><a href="blog-full2.php ">Blog Full Page 2</a></li>
                    <li><a href="blog-post.php ">Blog Post 1</a></li>
                    <li><a href="blog-post2.php ">Blog Post 2</a></li>
                </ul>
            </li>
            <li class="card " role="tab " id="sch5 ">
                ...
                <ul id="sc5 " class="card-collapse collapse " role="tabpanel " aria-labelledby="sch5 " data-parent="#slidebar-menu ">
                    <li><a href="ecommerce-filters.php ">E-Commerce Sidebar</a></li>
                    <li><a href="ecommerce-filters-full.php ">E-Commerce Sidebar Full</a></li>
                    <li><a href="ecommerce-filters-full2.php ">E-Commerce Topbar Full</a></li>
                    <li><a href="ecommerce-item.php ">E-Commerce Item</a></li>
            ...
            <li class="card " role="tab " id="sch6 ">
                ...
                <ul id="sc6 " class="card-collapse collapse " role="tabpanel " aria-labelledby="sch6 " data-parent="#slidebar-menu ">
                    <li><a href="portfolio-filters_sidebar.php ">Portfolio Sidebar Filters</a></li>
                    <li><a href="portfolio-filters_topbar.php ">Portfolio Topbar Filters</a></li>
                    <li><a href="portfolio-filters_sidebar_fluid.php ">Portfolio Sidebar Fluid</a></li>
                    <li><a href="portfolio-filters_topbar_fluid.php ">Portfolio Topbar Fluid</a></li>
                    <li><a href="portfolio-cards.php ">Porfolio Cards</a></li>
                    <li><a href="portfolio-masonry.php ">Porfolio Masonry</a></li>
                    <li><a href="portfolio-item.php ">Portfolio Item 1</a></li>
                    <li><a href="portfolio-item2.php ">Portfolio Item 2</a></li>
                </ul>
            </li>
            <li>
                <a class="link " href="component-typography.php "><i class="zmdi zmdi-view-compact "></i> UI Elements</a>
            </li>
            <li>
                <a class="link " href="page-all.php "><i class="zmdi zmdi-link "></i> All Pages</a>
            </li>
        </ul>
        ...
        <div class="ms-slidebar-social ms-slidebar-block ">
            ...
            <div class="ms-slidebar-social ">
                <a href="javascript:void(0) " class="btn-circle btn-circle-raised btn-facebook "><i class="zmdi zmdi-facebook "></i> <span class="badge-pill badge-pill-pink ">12</span><div class="ripple-container "></div></a>
                <a href="javascript:void(0) " class="btn-circle btn-circle-raised btn-twitter "><i class="zmdi zmdi-twitter "></i> <span class="badge-pill badge-pill-pink ">4</span><div class="ripple-container "></div></a>
                <a href="javascript:void(0) " class="btn-circle btn-circle-raised btn-google "><i class="zmdi zmdi-google "></i><div class="ripple-container "></div></a>
                <a href="javascript:void(0) " class="btn-circle btn-circle-raised btn-instagram "><i class="zmdi zmdi-instagram "></i><div class="ripple-container "></div></a>
            </div>
        </div>
    </div>
</div>
