            ...
            <div class="container">
              ...
              <div class="row">
                ...
                <div class="col-lg-6">
                  <div class="ms-collapse" id="accordion2" role="tablist" aria-multiselectable="true">
                    <div class="mb-0 card card-warning wow fadeInUp animation-delay-2">
                    ...
                    <div class="mb-0 card card-warning wow fadeInUp animation-delay-5">
                    ...
                    <div class="mb-0 card card-warning wow fadeInUp animation-delay-7">
              ...
              <div class="mt-6 color-dark">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="card card-info-inverse card-body overflow-hidden text-center wow zoomInUp animation-delay-3">
                    ...
                    <figure class="ms-thumbnail ms-thumbnail-top ms-thumbnail-info">
                      ...
                      <figcaption class="ms-thumbnail-caption text-center">
                        <div class="ms-thumbnail-caption-content">
                          ...
                          <a href="javascript:void(0)" class="btn btn-raised btn-white color-success">
