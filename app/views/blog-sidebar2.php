          ...
          <div class="col-lg-8">
            <article class="card wow fadeInLeft animation-delay-5 mb-4">
              <div class="card-body overflow-hidden overflow-hidden">
                <div class="row">
                  <div class="col-xl-6">
                    <img src="assets/img/demo/post4.jpg" alt="" class="img-fluid mb-4"> </div>
                  <div class="col-xl-6">
                    <h3 class="no-mt">
                ...
                <div class="row">
                  <div class="col-lg-8">
                    <img src="assets/img/demo/avatar50.jpg" alt="..." class="rounded-circle mr-1"> by
            ...
            <article class="card wow fadeInLeft animation-delay-5 mb-4">
              <div class="card-body overflow-hidden">
                <div class="row">
                  <div class="col-lg-6">
                    <img src="assets/img/demo/post5.jpg" alt="" class="img-fluid mb-4"> </div>
                  <div class="col-lg-6">
                    <h3 class="no-mt">
                      <a href="javascript:void(0)">Earum delectus libero ipsa temporibus in minus</a>
                    </h3>
            ...
            <article class="card wow fadeInLeft animation-delay-5 mb-4">
              <div class="card-body overflow-hidden">
                <div class="row">
                  <div class="col-lg-6">
                    <img src="assets/img/demo/post2.jpg" alt="" class="img-fluid mb-4"> </div>
                  <div class="col-lg-6">
                    <h3 class="no-mt">
                      <a href="javascript:void(0)">Earum delectus libero ipsa temporibus in minus</a>
                    </h3>
            ...
            <article class="card wow fadeInLeft animation-delay-5 mb-4">
              <div class="card-body overflow-hidden">
                <div class="row">
                  <div class="col-lg-6">
                    <img src="assets/img/demo/post3.jpg" alt="" class="img-fluid mb-4"> </div>
                  <div class="col-lg-6">
                    <h3 class="no-mt">
                      <a href="javascript:void(0)">Earum delectus libero ipsa temporibus in minus</a>
                    </h3>
            ...
            <article class="card wow fadeInLeft animation-delay-5 mb-4">
              <div class="card-body overflow-hidden">
                <div class="row">
                  <div class="col-lg-6">
                    <img src="assets/img/demo/post1.jpg" alt="" class="img-fluid mb-4"> </div>
                  <div class="col-lg-6">
                    <h3 class="no-mt">
                      <a href="javascript:void(0)">Earum delectus libero ipsa temporibus in minus</a>
                    </h3>
