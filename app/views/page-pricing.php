...
<html lang="en">
  ...
  <body>
    ...
    <div class="ms-site-container">
      ...
      <!-- container -->
      <div class="wrap ms-hero-bg-info ms-hero-img-meeting ms-bg-fixed mb-6 mt-2">
        <div class="container">
            ...
            <div class="col-lg-4 col-md-6 col-sm-6 mb-2">
              <div class="ms-icon-feature wow flipInX animation-delay-4">
                ...
                <div class="ms-icon-feature-content">
                  ...
                  <p class="color-white">Praesentium cumque voluptate harum quae doloribus, atque error debitis, amet velit in similique, necessitatibus odit vero sunt.</p>
                </div>
              </div>
            </div>
            <div class="col-lg-4 col-md-6 col-sm-6 mb-2">
