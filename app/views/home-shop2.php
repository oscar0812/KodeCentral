            ...
            <div class="carousel-inner" role="listbox">
              <div class="carousel-item active">
                <div class="row">
                  ...
                  <div class="col-md-6 col-md-pull-6">
                    <img src="assets/img/demo/macbook2016.png" class="img-fluid" alt="..."> </div>
                </div>
              </div>
              <div class="carousel-item">
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <img src="assets/img/demo/watch.png" class="img-fluid" alt="..."> </div>
                </div>
              </div>
              <div class="carousel-item">
                <div class="row">
                  ...
                  <div class="col-md-6 col-md-pull-6">
                    <img src="assets/img/demo/book.png" class="img-fluid" alt="..."> </div>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="wrap ms-hero-img-beach ms-hero-bg-primary ms-bg-fixed">
        <div class="container index-1">
          <div class="text-center color-white mb-4">
            ...
            <p class="lead">Welcome to the Material Style Store. Discover the latest products at incredible prices.
