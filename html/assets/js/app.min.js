...
function slidebar() {
  var t = $(".ms-slidebar"),
    ...
    i = !1;
  n.click(function() {
    i ? (t.removeClass("open"), i = !1) : (t.addClass("open"), i = !0), e = !0
  }), o.click(function() {
  ...
  c.fn.dropdownHover = function(l) {
    ...
    $(window).scroll(function() {
      if (n.hasClass("stay-on-top-navbar")) return;
...
// data-url tag, but not if its empty
$("body").on('click', '[data-url]', function(e) {
  if (!$(e.target).hasClass('child-click')) {
    // change page to url in data-url
    window.location.href = $(this).attr('data-url');
  }

});

$('.refresh-logout').on('click', function() {
  item = $(this);
  $.ajax({
    type: "GET",
    url: item.attr('href'),
...
$('#ms-slidebar').find('form').on('submit', function(e) {
  if ($('#search-box-slidebar').val() == "")
    return false;
});

$('#subscribe-footer').on('submit', function(e) {
  Snackbar.show({
